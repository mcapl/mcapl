...
\section{Initialising and Finalising}
...
Similarly \texttt{public void finalize()} is called at the end of a run of the multi-agent system and so can be used for any final clean up of the environment or to print out reports or statistics.
