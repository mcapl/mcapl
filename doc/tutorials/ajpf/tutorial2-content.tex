...
\subsection{TwoPickUpAgents\_basic.jpf}\index{example!twopickupagents} is a minimal configuration file containing only options discussed in \ajpf\ tutorial 1.  This generates the following output:
