...
/**
 * Abstract class for eventually formulase.
 * 
 * @author louiseadennis
 *
 */
public class Abstract_Finally extends Abstract_Until {
	
	/**
	 * Constructor.
	 * @param p
	 */
	public Abstract_Finally(Abstract_Property p) {
		super(new Abstract_TrueProp(), p);
	}
