...
/**
 * Formula representing that f1 is a consequence of the action selected for this world.
 * @author louisedennis
 *
 */
public class Consequence extends Formula {
	public Consequence(Formula f1) {
		super(f1, null);
	}
}
