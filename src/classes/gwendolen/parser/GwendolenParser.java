// $ANTLR 3.5.1 /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g 2014-06-09 16:23:33
...
public class GwendolenParser extends Parser {
	public static final String[] tokenNames = new String[] {
		...
		"ADD_CONTENT", "ADD_CONTEXT", "ADD_PLAN", "BELIEFRULES", "BELIEFS", "BELIEVE", 
		"BRULEARROW", "CLOSE", "COLON", "COMMA", "COMMENT", "CONST", "CONSTRAINT", 
		"CURLYCLOSE", "CURLYOPEN", "DIV", "DOUBLEQUOTE", "EQ", "GOAL", "GOALS", 
		"GWENDOLEN", "IN_CONTENT", "IN_CONTEXT", "LESS", "LINE_COMMENT", "LOCK", 
		"MINUS", "MOD", "MULT", "NAME", "NEWLINE", "NOT", "NUMBER", "OPEN", "PERFORM", 
		"PERFORMGOAL", "PLANS", "PLUS", "POINT", "QUERY", "RECEIVED", "RULEARROW", 
		"SEMI", "SEND", "SENT", "SHRIEK", "SQCLOSE", "SQOPEN", "STRING", "TELL", 
		"TELLHOW", "TRUE", "VAR", "WS"
	};
	...
	// $ANTLR start "notfmla"
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:150:1: notfmla returns [Abstract_LogicalFormula f] : ( (gb= pred | SQOPEN eq= equation SQCLOSE ) | NOT (gb2= pred | SQOPEN eq= equation SQCLOSE |lf= subfmla ) );
	public final Abstract_LogicalFormula notfmla() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:150:45: ( (gb= pred | SQOPEN eq= equation SQCLOSE ) | NOT (gb2= pred | SQOPEN eq= equation SQCLOSE |lf= subfmla ) )
			int alt30=2;
			int LA30_0 = input.LA(1);
			if ( (LA30_0==CONST||LA30_0==SQOPEN||LA30_0==VAR) ) {
				alt30=1;
			}
			else if ( (LA30_0==NOT) ) {
				alt30=2;
			...
			switch (alt30) {
				case 1 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:150:47: (gb= pred | SQOPEN eq= equation SQCLOSE )
					{
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:150:47: (gb= pred | SQOPEN eq= equation SQCLOSE )
					int alt28=2;
					...
					switch (alt28) {
						case 1 :
							// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:150:48: gb= pred
							{
							...
							break;
						case 2 :
							// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:150:71: SQOPEN eq= equation SQCLOSE
							{
					...
					break;
				case 2 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:151:79: NOT (gb2= pred | SQOPEN eq= equation SQCLOSE |lf= subfmla )
					{
					match(input,NOT,FOLLOW_NOT_in_notfmla1140); 
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:151:83: (gb2= pred | SQOPEN eq= equation SQCLOSE |lf= subfmla )
					int alt29=3;
					switch ( input.LA(1) ) {
					case CONST:
					case VAR:
					...
					switch (alt29) {
						case 1 :
							...
							break;
						case 2 :
							// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:152:81: SQOPEN eq= equation SQCLOSE
							{
							...
							break;
						case 3 :
							// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:153:80: lf= subfmla
							{
	...
	// $ANTLR start "subfmla"
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:154:1: subfmla returns [Abstract_LogicalFormula f] : OPEN lf= logicalfmla CLOSE ;
	public final Abstract_LogicalFormula subfmla() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:154:45: ( OPEN lf= logicalfmla CLOSE )
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:154:47: OPEN lf= logicalfmla CLOSE
			{
	...
	// $ANTLR start "waitfor"
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:157:1: waitfor returns [Abstract_Literal wf] : MULT l= literal ;
	public final Abstract_Literal waitfor() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:157:39: ( MULT l= literal )
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:157:42: MULT l= literal
			{
	...
	// $ANTLR start "action"
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:159:1: action returns [Abstract_Action a] : ( ( SEND OPEN an= literal COMMA p= performative COMMA t= pred CLOSE ) |t= pred );
	public final Abstract_Action action() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:159:36: ( ( SEND OPEN an= literal COMMA p= performative COMMA t= pred CLOSE ) |t= pred )
			int alt31=2;
			...
			switch (alt31) {
				case 1 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:160:2: ( SEND OPEN an= literal COMMA p= performative COMMA t= pred CLOSE )
					{
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:160:2: ( SEND OPEN an= literal COMMA p= performative COMMA t= pred CLOSE )
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:160:3: SEND OPEN an= literal COMMA p= performative COMMA t= pred CLOSE
					{
					...
					break;
				case 2 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:161:2: t= pred
					{
	...
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:203:1: environment returns [String env] : w= classpath ;
	public final String environment() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:203:34: (w= classpath )
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:203:36: w= classpath
			{
	...
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:204:1: classpath returns [String s] : w= word ( POINT w1= word )+ ;
	public final String classpath() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:204:30: (w= word ( POINT w1= word )+ )
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:204:32: w= word ( POINT w1= word )+
			{
			...
			s = w;
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:204:52: ( POINT w1= word )+
			int cnt32=0;
			loop32:
			while (true) {
				int alt32=2;
				...
				switch (alt32) {
				case 1 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:204:53: POINT w1= word
					{
	...
	// $ANTLR start "word"
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:205:1: word returns [String s] : ( CONST | VAR ) ;
	public final String word() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:205:25: ( ( CONST | VAR ) )
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:205:27: ( CONST | VAR )
			{
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:205:27: ( CONST | VAR )
			int alt33=2;
			...
			switch (alt33) {
				case 1 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:205:28: CONST
					{
					...
					break;
				case 2 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:205:59: VAR
					{
	...
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:207:1: agentnameterm returns [Abstract_StringTerm s] : ( CONST |v= var );
	public final Abstract_StringTerm agentnameterm() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:207:47: ( CONST |v= var )
			int alt34=2;
			...
			switch (alt34) {
				case 1 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:207:49: CONST
					{
					...
					break;
				case 2 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:207:111: v= var
					{
	...
	// $ANTLR start "literal"
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:210:1: literal returns [Abstract_Literal l] : ( ( TRUE | NOT nt= pred ) |t= pred );
	public final Abstract_Literal literal() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:210:37: ( ( TRUE | NOT nt= pred ) |t= pred )
			int alt36=2;
			...
			switch (alt36) {
				case 1 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:210:40: ( TRUE | NOT nt= pred )
					{
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:210:40: ( TRUE | NOT nt= pred )
					int alt35=2;
					...
					switch (alt35) {
						case 1 :
							// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:210:41: TRUE
							{
							...
							break;
						case 2 :
							// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:211:5: NOT nt= pred
							{
					...
					break;
				case 2 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:215:5: t= pred
					{
	...
	// $ANTLR start "pred"
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:219:1: pred returns [Abstract_Predicate t] : (v= var |f= function );
	public final Abstract_Predicate pred() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:219:37: (v= var |f= function )
			int alt37=2;
			...
			switch (alt37) {
				case 1 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:219:39: v= var
					{
					...
					break;
				case 2 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:219:59: f= function
					{
	...
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:220:1: function returns [Abstract_Predicate f] : CONST ( OPEN terms[$f] CLOSE )? ;
	public final Abstract_Predicate function() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:220:40: ( CONST ( OPEN terms[$f] CLOSE )? )
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:220:42: CONST ( OPEN terms[$f] CLOSE )?
			{
			CONST4=(Token)match(input,CONST,FOLLOW_CONST_in_function2021); 
			f = new Abstract_Predicate(CONST4.getText());
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:220:97: ( OPEN terms[$f] CLOSE )?
			int alt38=2;
			...
			switch (alt38) {
				case 1 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:220:98: OPEN terms[$f] CLOSE
					{
	...
	// $ANTLR start "terms"
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:222:1: terms[Abstract_Predicate f] : t= term ( COMMA terms[$f] )? ;
	public final void terms(Abstract_Predicate f) throws RecognitionException {
		Abstract_Term t =null;

		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:222:29: (t= term ( COMMA terms[$f] )? )
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:222:31: t= term ( COMMA terms[$f] )?
			{
			...
			f.addTerm(t);
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:222:58: ( COMMA terms[$f] )?
			int alt39=2;
			...
			switch (alt39) {
				case 1 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:222:59: COMMA terms[$f]
					{
	...
	// $ANTLR start "term"
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:223:1: term returns [Abstract_Term t] : (a= atom |s= stringterm |f= function );
	public final Abstract_Term term() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:223:31: (a= atom |s= stringterm |f= function )
			int alt40=3;
			switch ( input.LA(1) ) {
			case MINUS:
			case NUMBER:
			...
			switch (alt40) {
				case 1 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:223:34: a= atom
					{
					...
					break;
				case 2 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:223:58: s= stringterm
					{
					...
					break;
				case 3 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:223:88: f= function
					{
	...
	// $ANTLR start "atom"
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:225:1: atom returns [Abstract_NumberTerm t] : (n= numberstring |v= var | OPEN a= arithexpr CLOSE );
	public final Abstract_NumberTerm atom() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:225:38: (n= numberstring |v= var | OPEN a= arithexpr CLOSE )
			int alt41=3;
			switch ( input.LA(1) ) {
			case MINUS:
			case NUMBER:
			...
			switch (alt41) {
				case 1 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:225:40: n= numberstring
					{
					...
					break;
				case 2 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:226:6: v= var
					{
					...
					break;
				case 3 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:226:27: OPEN a= arithexpr CLOSE
					{
					match(input,OPEN,FOLLOW_OPEN_in_atom2125); 
					pushFollow(FOLLOW_arithexpr_in_atom2129);
					a=arithexpr();
					state._fsp--;

					match(input,CLOSE,FOLLOW_CLOSE_in_atom2131); 
					t = a;
					}
					break;
	...
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:227:1: stringterm returns [Abstract_StringTerm s] : DOUBLEQUOTE STRING DOUBLEQUOTE ;
	public final Abstract_StringTerm stringterm() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:227:44: ( DOUBLEQUOTE STRING DOUBLEQUOTE )
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:227:46: DOUBLEQUOTE STRING DOUBLEQUOTE
			{
			match(input,DOUBLEQUOTE,FOLLOW_DOUBLEQUOTE_in_stringterm2144); 
			STRING5=(Token)match(input,STRING,FOLLOW_STRING_in_stringterm2147); 
			match(input,DOUBLEQUOTE,FOLLOW_DOUBLEQUOTE_in_stringterm2149); 
	...
	// $ANTLR start "var"
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:230:1: var returns [Abstract_VarTerm v] : VAR ;
	public final Abstract_VarTerm var() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:230:34: ( VAR )
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:230:36: VAR
			{
			VAR6=(Token)match(input,VAR,FOLLOW_VAR_in_var2163); 
	...
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:239:1: numberstring returns [String s] : ( MINUS )? (n1= NUMBER ( POINT n2= NUMBER )? ) ;
	public final String numberstring() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:239:33: ( ( MINUS )? (n1= NUMBER ( POINT n2= NUMBER )? ) )
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:239:35: ( MINUS )? (n1= NUMBER ( POINT n2= NUMBER )? )
			{
			s = "";
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:239:46: ( MINUS )?
			int alt42=2;
			...
			switch (alt42) {
				case 1 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:239:47: MINUS
					{
					match(input,MINUS,FOLLOW_MINUS_in_numberstring2180); 
					s += "-";
					}
					break;
			...
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:239:68: (n1= NUMBER ( POINT n2= NUMBER )? )
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:239:69: n1= NUMBER ( POINT n2= NUMBER )?
			{
			n1=(Token)match(input,NUMBER,FOLLOW_NUMBER_in_numberstring2189); 
			s += n1.getText();
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:240:6: ( POINT n2= NUMBER )?
			int alt43=2;
			...
			switch (alt43) {
				case 1 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:240:7: POINT n2= NUMBER
					{
					match(input,POINT,FOLLOW_POINT_in_numberstring2199); 
					s += ".";
					n2=(Token)match(input,NUMBER,FOLLOW_NUMBER_in_numberstring2205); 
					s += n2.getText();
					}
					break;
	...
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:241:1: equation returns [Abstract_Equation eq] : a1= arithexpr oper= eqoper a2= arithexpr ;
	public final Abstract_Equation equation() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:241:40: (a1= arithexpr oper= eqoper a2= arithexpr )
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:241:42: a1= arithexpr oper= eqoper a2= arithexpr
			{
	...
	// $ANTLR start "eqoper"
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:242:1: eqoper returns [int oper] : ( LESS | EQ );
	public final int eqoper() throws RecognitionException {
		int oper = 0;


		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:242:27: ( LESS | EQ )
			int alt44=2;
			...
			switch (alt44) {
				case 1 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:242:29: LESS
					{
					match(input,LESS,FOLLOW_LESS_in_eqoper2244); 
					oper =Abstract_Equation.less;
					}
					break;
				case 2 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:242:68: EQ
					{
					match(input,EQ,FOLLOW_EQ_in_eqoper2250); 
	...
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:244:1: arithexpr returns [Abstract_NumberTerm t] : m= multexpr (oper= addoper m1= multexpr )? ;
	public final Abstract_NumberTerm arithexpr() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:244:43: (m= multexpr (oper= addoper m1= multexpr )? )
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:244:45: m= multexpr (oper= addoper m1= multexpr )?
			{
			...
			t = m;
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:244:69: (oper= addoper m1= multexpr )?
			int alt45=2;
			...
			switch (alt45) {
				case 1 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:244:71: oper= addoper m1= multexpr
					{
	...
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:245:1: multexpr returns [Abstract_NumberTerm t] : a= atom (oper= multoper a1= atom )? ;
	public final Abstract_NumberTerm multexpr() throws RecognitionException {
		...
		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:245:42: (a= atom (oper= multoper a1= atom )? )
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:245:44: a= atom (oper= multoper a1= atom )?
			{
			...
			t = a;
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:245:64: (oper= multoper a1= atom )?
			int alt46=2;
			...
			switch (alt46) {
				case 1 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:245:65: oper= multoper a1= atom
					{
	...
	// $ANTLR start "addoper"
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:247:1: addoper returns [int oper] : ( PLUS | MINUS ) ;
	public final int addoper() throws RecognitionException {
		int oper = 0;


		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:247:28: ( ( PLUS | MINUS ) )
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:247:30: ( PLUS | MINUS )
			{
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:247:30: ( PLUS | MINUS )
			int alt47=2;
			...
			switch (alt47) {
				case 1 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:247:31: PLUS
					{
					match(input,PLUS,FOLLOW_PLUS_in_addoper2323); 
					oper =Abstract_ArithExpr.plus;
					}
					break;
				case 2 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:247:70: MINUS
					{
					match(input,MINUS,FOLLOW_MINUS_in_addoper2328); 
	...
	// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:248:1: multoper returns [int oper] : ( MULT | DIV | MOD ) ;
	public final int multoper() throws RecognitionException {
		int oper = 0;


		try {
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:248:29: ( ( MULT | DIV | MOD ) )
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:248:31: ( MULT | DIV | MOD )
			{
			// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:248:31: ( MULT | DIV | MOD )
			int alt48=3;
			switch ( input.LA(1) ) {
			...
			switch (alt48) {
				case 1 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:248:32: MULT
					{
					match(input,MULT,FOLLOW_MULT_in_multoper2343); 
					oper =Abstract_ArithExpr.times;
					}
					break;
				case 2 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:248:73: DIV
					{
					match(input,DIV,FOLLOW_DIV_in_multoper2349); 
					oper =Abstract_ArithExpr.div;
					}
					break;
				case 3 :
					// /Users/louiseadennis/Eclipse/mcapl/src/classes/gwendolen/parser/Gwendolen.g:248:111: MOD
					{
					match(input,MOD,FOLLOW_MOD_in_multoper2355); 
	...
	public static final BitSet FOLLOW_BELIEFRULES_in_gwendolenagent168 = new BitSet(new long[]{0x0800000004040000L});
	public static final BitSet FOLLOW_brule_in_gwendolenagent173 = new BitSet(new long[]{0x0800000004040000L});
	...
	public static final BitSet FOLLOW_pred_in_brule948 = new BitSet(new long[]{0x0002000000002000L});
	public static final BitSet FOLLOW_BRULEARROW_in_brule951 = new BitSet(new long[]{0x0840004000040000L});
	...
	public static final BitSet FOLLOW_COMMA_in_logicalfmla1000 = new BitSet(new long[]{0x0840004000040000L});
	...
	public static final BitSet FOLLOW_SQOPEN_in_notfmla1046 = new BitSet(new long[]{0x0800018200000000L});
	public static final BitSet FOLLOW_equation_in_notfmla1052 = new BitSet(new long[]{0x0020000000000000L});
	public static final BitSet FOLLOW_SQCLOSE_in_notfmla1056 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_NOT_in_notfmla1140 = new BitSet(new long[]{0x0840010000040000L});
	public static final BitSet FOLLOW_pred_in_notfmla1147 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_SQOPEN_in_notfmla1234 = new BitSet(new long[]{0x0800018200000000L});
	public static final BitSet FOLLOW_equation_in_notfmla1240 = new BitSet(new long[]{0x0020000000000000L});
	...
	public static final BitSet FOLLOW_OPEN_in_subfmla1345 = new BitSet(new long[]{0x0840004000040000L});
	public static final BitSet FOLLOW_logicalfmla_in_subfmla1351 = new BitSet(new long[]{0x0000000000004000L});
	public static final BitSet FOLLOW_CLOSE_in_subfmla1355 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_MULT_in_waitfor1370 = new BitSet(new long[]{0x0C00004000040000L});
	public static final BitSet FOLLOW_literal_in_waitfor1374 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_SEND_in_action1391 = new BitSet(new long[]{0x0000010000000000L});
	public static final BitSet FOLLOW_OPEN_in_action1393 = new BitSet(new long[]{0x0C00004000040000L});
	public static final BitSet FOLLOW_literal_in_action1397 = new BitSet(new long[]{0x0000000000010000L});
	public static final BitSet FOLLOW_COMMA_in_action1399 = new BitSet(new long[]{0x0300020000080010L});
	public static final BitSet FOLLOW_performative_in_action1403 = new BitSet(new long[]{0x0000000000010000L});
	public static final BitSet FOLLOW_COMMA_in_action1405 = new BitSet(new long[]{0x0800000000040000L});
	public static final BitSet FOLLOW_pred_in_action1409 = new BitSet(new long[]{0x0000000000004000L});
	...
	public static final BitSet FOLLOW_word_in_classpath1717 = new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_POINT_in_classpath1722 = new BitSet(new long[]{0x0800000000040000L});
	public static final BitSet FOLLOW_word_in_classpath1726 = new BitSet(new long[]{0x0000200000000002L});
	...
	public static final BitSet FOLLOW_NOT_in_literal1968 = new BitSet(new long[]{0x0800000000040000L});
	...
	public static final BitSet FOLLOW_CONST_in_function2021 = new BitSet(new long[]{0x0000010000000002L});
	public static final BitSet FOLLOW_OPEN_in_function2026 = new BitSet(new long[]{0x0800018200840000L});
	public static final BitSet FOLLOW_terms_in_function2028 = new BitSet(new long[]{0x0000000000004000L});
	public static final BitSet FOLLOW_CLOSE_in_function2031 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_term_in_terms2044 = new BitSet(new long[]{0x0000000000010002L});
	public static final BitSet FOLLOW_COMMA_in_terms2049 = new BitSet(new long[]{0x0800018200840000L});
	...
	public static final BitSet FOLLOW_stringterm_in_term2080 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_function_in_term2088 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_numberstring_in_atom2106 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_var_in_atom2119 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_OPEN_in_atom2125 = new BitSet(new long[]{0x0800018200000000L});
	public static final BitSet FOLLOW_arithexpr_in_atom2129 = new BitSet(new long[]{0x0000000000004000L});
	public static final BitSet FOLLOW_CLOSE_in_atom2131 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_DOUBLEQUOTE_in_stringterm2144 = new BitSet(new long[]{0x0080000000000000L});
	public static final BitSet FOLLOW_STRING_in_stringterm2147 = new BitSet(new long[]{0x0000000000800000L});
	public static final BitSet FOLLOW_DOUBLEQUOTE_in_stringterm2149 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_VAR_in_var2163 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_MINUS_in_numberstring2180 = new BitSet(new long[]{0x0000008000000000L});
	public static final BitSet FOLLOW_NUMBER_in_numberstring2189 = new BitSet(new long[]{0x0000200000000002L});
	public static final BitSet FOLLOW_POINT_in_numberstring2199 = new BitSet(new long[]{0x0000008000000000L});
	public static final BitSet FOLLOW_NUMBER_in_numberstring2205 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_arithexpr_in_equation2222 = new BitSet(new long[]{0x0000000041000000L});
	public static final BitSet FOLLOW_eqoper_in_equation2226 = new BitSet(new long[]{0x0800018200000000L});
	public static final BitSet FOLLOW_arithexpr_in_equation2230 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_LESS_in_eqoper2244 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_EQ_in_eqoper2250 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_multexpr_in_arithexpr2266 = new BitSet(new long[]{0x0000100200000002L});
	public static final BitSet FOLLOW_addoper_in_arithexpr2274 = new BitSet(new long[]{0x0800018200000000L});
	public static final BitSet FOLLOW_multexpr_in_arithexpr2278 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_atom_in_multexpr2295 = new BitSet(new long[]{0x0000000C00400002L});
	public static final BitSet FOLLOW_multoper_in_multexpr2302 = new BitSet(new long[]{0x0800018200000000L});
	public static final BitSet FOLLOW_atom_in_multexpr2306 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_PLUS_in_addoper2323 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_MINUS_in_addoper2328 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_MULT_in_multoper2343 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_DIV_in_multoper2349 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_MOD_in_multoper2355 = new BitSet(new long[]{0x0000000000000002L});
}
