// $ANTLR 3.5.1 /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g 2014-08-07 16:21:58
...
public class EASSParser extends Parser {
		...
		try {
			...
			switch (alt25) {
				...
				case 7 :
					...
					{
					match(input,TRUE,FOLLOW_TRUE_in_guard_atom846); 
		...
		try {
			...
			switch (alt30) {
				case 1 :
					...
					switch (alt29) {
						case 1 :
							...
							switch (alt28) {
								case 1 :
									...
									{
									match(input,PLUS,FOLLOW_PLUS_in_deed870); 
									...
									switch (alt26) {
										case 1 :
											...
											{
											pushFollow(FOLLOW_literal_in_deed875);
											l=literal();
											state._fsp--;
										...
										case 2 :
											...
											{
											match(input,SHRIEK,FOLLOW_SHRIEK_in_deed885); 
											pushFollow(FOLLOW_goal_in_deed889);
											g=goal();
											state._fsp--;
										...
										case 3 :
											...
											{
											match(input,LOCK,FOLLOW_LOCK_in_deed899); 
										...
										case 4 :
											...
											{
											match(input,PLAN,FOLLOW_PLAN_in_deed908); 
											match(input,OPEN,FOLLOW_OPEN_in_deed910); 
											pushFollow(FOLLOW_pred_in_deed914);
											p=pred();
											state._fsp--;

											match(input,CLOSE,FOLLOW_CLOSE_in_deed916); 
								...
								case 2 :
									...
									{
									match(input,MINUS,FOLLOW_MINUS_in_deed929); 
									...
									switch (alt27) {
										case 1 :
											...
											{
											pushFollow(FOLLOW_literal_in_deed934);
											l=literal();
											state._fsp--;
										...
										case 2 :
											...
											{
											match(input,SHRIEK,FOLLOW_SHRIEK_in_deed944); 
											pushFollow(FOLLOW_goal_in_deed948);
											g=goal();
											state._fsp--;
										...
										case 3 :
											...
											{
											match(input,LOCK,FOLLOW_LOCK_in_deed958); 
										...
										case 4 :
											...
											{
											match(input,PLAN,FOLLOW_PLAN_in_deed968); 
											match(input,OPEN,FOLLOW_OPEN_in_deed970); 
											pushFollow(FOLLOW_pred_in_deed974);
											p=pred();
											state._fsp--;

											match(input,CLOSE,FOLLOW_CLOSE_in_deed976); 
						...
						case 2 :
							...
							{
							match(input,UPDATE,FOLLOW_UPDATE_in_deed993); 
							...
							{
							pushFollow(FOLLOW_literal_in_deed998);
							l=literal();
							state._fsp--;
						...
						case 3 :
							...
							{
							match(input,CALCULATE,FOLLOW_CALCULATE_in_deed1009); 
							pushFollow(FOLLOW_calculation_in_deed1013);
							c=calculation(ds);
							state._fsp--;
						...
						case 4 :
							...
							{
							match(input,QUERYCOM,FOLLOW_QUERYCOM_in_deed1024); 
							pushFollow(FOLLOW_query_in_deed1028);
							q=query(ds);
							state._fsp--;
						...
						case 5 :
							...
							{
							match(input,WAIT,FOLLOW_WAIT_in_deed1039); 
							pushFollow(FOLLOW_wait_in_deed1043);
							w=wait(ds);
							state._fsp--;
						...
						case 6 :
							...
							{
							pushFollow(FOLLOW_action_in_deed1056);
							a=action();
							state._fsp--;
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_waitfor_in_deed1069);
					wf=waitfor();
					state._fsp--;
				...
				case 3 :
					...
					{
					match(input,SUBSTITUTE,FOLLOW_SUBSTITUTE_in_deed1079); 
					pushFollow(FOLLOW_substitution_in_deed1083);
					s=substitution(ds);
					state._fsp--;
	...
	public final Abstract_Deed substitution(ArrayList<Abstract_Deed> ds) throws RecognitionException {
		...
		try {
			...
			{
			match(input,OPEN,FOLLOW_OPEN_in_substitution1114); 
			pushFollow(FOLLOW_pred_in_substitution1118);
			pl1=pred();
			state._fsp--;

			match(input,COMMA,FOLLOW_COMMA_in_substitution1120); 
			pushFollow(FOLLOW_pred_in_substitution1126);
			c1=pred();
			state._fsp--;

			match(input,COMMA,FOLLOW_COMMA_in_substitution1128); 
			pushFollow(FOLLOW_pred_in_substitution1133);
			c2=pred();
			state._fsp--;

			match(input,COMMA,FOLLOW_COMMA_in_substitution1135); 
			pushFollow(FOLLOW_pred_in_substitution1141);
			pl2=pred();
			state._fsp--;

			match(input,CLOSE,FOLLOW_CLOSE_in_substitution1143); 
	...
	public final Abstract_Deed calculation(ArrayList<Abstract_Deed> ds) throws RecognitionException {
		...
		try {
			...
			{
			match(input,OPEN,FOLLOW_OPEN_in_calculation1163); 
			pushFollow(FOLLOW_literal_in_calculation1169);
			l1=literal();
			state._fsp--;

			match(input,COMMA,FOLLOW_COMMA_in_calculation1171); 
			pushFollow(FOLLOW_var_in_calculation1175);
			v=var();
			state._fsp--;

			match(input,CLOSE,FOLLOW_CLOSE_in_calculation1177); 
	...
	public final Abstract_Deed query(ArrayList<Abstract_Deed> ds) throws RecognitionException {
		...
		try {
			...
			{
			match(input,OPEN,FOLLOW_OPEN_in_query1195); 
			pushFollow(FOLLOW_literal_in_query1201);
			l1=literal();
			state._fsp--;

			match(input,CLOSE,FOLLOW_CLOSE_in_query1204); 
	...
	public final Abstract_Deed wait(ArrayList<Abstract_Deed> ds) throws RecognitionException {
		...
		try {
			...
			{
			match(input,OPEN,FOLLOW_OPEN_in_wait1222); 
			pushFollow(FOLLOW_term_in_wait1228);
			l1=term();
			state._fsp--;

			match(input,COMMA,FOLLOW_COMMA_in_wait1230); 
			pushFollow(FOLLOW_literal_in_wait1234);
			l2=literal();
			state._fsp--;

			match(input,CLOSE,FOLLOW_CLOSE_in_wait1236); 
	...
	public final Abstract_Rule brule() throws RecognitionException {
		...
		try {
			...
			{
			pushFollow(FOLLOW_pred_in_brule1258);
			head=pred();
			state._fsp--;
			...
			switch (alt31) {
				case 1 :
					...
					{
					match(input,BRULEARROW,FOLLOW_BRULEARROW_in_brule1261); 
					pushFollow(FOLLOW_logicalfmla_in_brule1265);
					f=logicalfmla();
					state._fsp--;

					r = new Abstract_Rule(head, f);
					match(input,SEMI,FOLLOW_SEMI_in_brule1269); 
					}
					break;
				case 2 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:153:116: SEMI
					{
					match(input,SEMI,FOLLOW_SEMI_in_brule1273); 
	...
	public final Abstract_LogicalFormula logicalfmla() throws RecognitionException {
		...
		try {
			...
			{
			pushFollow(FOLLOW_notfmla_in_logicalfmla1290);
			n=notfmla();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,COMMA,FOLLOW_COMMA_in_logicalfmla1310); 
	...
	// $ANTLR start "notfmla"
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:158:1: notfmla returns [Abstract_LogicalFormula f] : (gb= pred | NOT (gb2= pred |lf= subfmla ) );
	public final Abstract_LogicalFormula notfmla() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:158:45: (gb= pred | NOT (gb2= pred |lf= subfmla ) )
			int alt34=2;
			...
			switch (alt34) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:158:47: gb= pred
					{
					pushFollow(FOLLOW_pred_in_notfmla1349);
					gb=pred();
					state._fsp--;
					...
					break;
				case 2 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:159:79: NOT (gb2= pred |lf= subfmla )
					{
					match(input,NOT,FOLLOW_NOT_in_notfmla1434); 
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:159:83: (gb2= pred |lf= subfmla )
					int alt33=2;
					...
					switch (alt33) {
						case 1 :
							...
							{
							pushFollow(FOLLOW_pred_in_notfmla1441);
							gb2=pred();
							state._fsp--;
							...
							break;
						case 2 :
							// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:159:153: lf= subfmla
							{
							pushFollow(FOLLOW_subfmla_in_notfmla1451);
							lf=subfmla();
							state._fsp--;
	...
	// $ANTLR start "subfmla"
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:160:1: subfmla returns [Abstract_LogicalFormula f] : OPEN lf= logicalfmla CLOSE ;
	public final Abstract_LogicalFormula subfmla() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:160:45: ( OPEN lf= logicalfmla CLOSE )
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:160:47: OPEN lf= logicalfmla CLOSE
			{
			match(input,OPEN,FOLLOW_OPEN_in_subfmla1465); 
			pushFollow(FOLLOW_logicalfmla_in_subfmla1471);
			lf=logicalfmla();
			state._fsp--;

			f = lf;
			match(input,CLOSE,FOLLOW_CLOSE_in_subfmla1475); 
			}
	...
	// $ANTLR start "waitfor"
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:162:1: waitfor returns [Abstract_Literal wf] : MULT l= literal ;
	public final Abstract_Literal waitfor() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:162:39: ( MULT l= literal )
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:162:42: MULT l= literal
			{
			match(input,MULT,FOLLOW_MULT_in_waitfor1489); 
			pushFollow(FOLLOW_literal_in_waitfor1493);
			l=literal();
			state._fsp--;
	...
	// $ANTLR start "action"
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:164:1: action returns [Abstract_Action a] : ( (a1= atom PLUS a2= atom EQ_ASSGN v= var ) | ( SEND OPEN an= literal COMMA p= performative COMMA t= pred CLOSE ) |t= pred );
	public final Abstract_Action action() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:164:36: ( (a1= atom PLUS a2= atom EQ_ASSGN v= var ) | ( SEND OPEN an= literal COMMA p= performative COMMA t= pred CLOSE ) |t= pred )
			int alt35=3;
			switch ( input.LA(1) ) {
			case MINUS:
			case NUMBER:
			...
			switch (alt35) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:165:2: (a1= atom PLUS a2= atom EQ_ASSGN v= var )
					{
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:165:2: (a1= atom PLUS a2= atom EQ_ASSGN v= var )
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:165:3: a1= atom PLUS a2= atom EQ_ASSGN v= var
					{
					pushFollow(FOLLOW_atom_in_action1512);
					a1=atom();
					state._fsp--;

					match(input,PLUS,FOLLOW_PLUS_in_action1514); 
					pushFollow(FOLLOW_atom_in_action1518);
					a2=atom();
					state._fsp--;

					match(input,EQ_ASSGN,FOLLOW_EQ_ASSGN_in_action1520); 
					pushFollow(FOLLOW_var_in_action1524);
					v=var();
					state._fsp--;
					...
					break;
				case 2 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:166:2: ( SEND OPEN an= literal COMMA p= performative COMMA t= pred CLOSE )
					{
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:166:2: ( SEND OPEN an= literal COMMA p= performative COMMA t= pred CLOSE )
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:166:3: SEND OPEN an= literal COMMA p= performative COMMA t= pred CLOSE
					{
					match(input,SEND,FOLLOW_SEND_in_action1533); 
					match(input,OPEN,FOLLOW_OPEN_in_action1535); 
					pushFollow(FOLLOW_literal_in_action1539);
					an=literal();
					state._fsp--;

					match(input,COMMA,FOLLOW_COMMA_in_action1541); 
					pushFollow(FOLLOW_performative_in_action1545);
					p=performative();
					state._fsp--;

					match(input,COMMA,FOLLOW_COMMA_in_action1547); 
					pushFollow(FOLLOW_pred_in_action1551);
					t=pred();
					state._fsp--;

					match(input,CLOSE,FOLLOW_CLOSE_in_action1553); 
					...
					break;
				case 3 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:167:2: t= pred
					{
					pushFollow(FOLLOW_pred_in_action1564);
					t=pred();
					state._fsp--;
	...
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:169:1: performative returns [int b] : ( TELL | PERFORM | ACHIEVE ) ;
	public final int performative() throws RecognitionException {
		int b = 0;


		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:169:30: ( ( TELL | PERFORM | ACHIEVE ) )
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:169:32: ( TELL | PERFORM | ACHIEVE )
			{
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:169:32: ( TELL | PERFORM | ACHIEVE )
			int alt36=3;
			switch ( input.LA(1) ) {
			...
			switch (alt36) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:169:33: TELL
					{
					match(input,TELL,FOLLOW_TELL_in_performative1579); 
					b =1;
					}
					break;
				case 2 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:169:48: PERFORM
					{
					match(input,PERFORM,FOLLOW_PERFORM_in_performative1585); 
					b =2;
					}
					break;
				case 3 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:169:66: ACHIEVE
					{
					match(input,ACHIEVE,FOLLOW_ACHIEVE_in_performative1591); 
					b = 3;
					}
					break;
	...
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:212:1: environment returns [String env] : w= classpath ;
	public final String environment() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:212:34: (w= classpath )
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:212:36: w= classpath
			{
			pushFollow(FOLLOW_classpath_in_environment1882);
			w=classpath();
			state._fsp--;
	...
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:213:1: classpath returns [String s] : w= word ( POINT w1= word )+ ;
	public final String classpath() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:213:30: (w= word ( POINT w1= word )+ )
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:213:32: w= word ( POINT w1= word )+
			{
			pushFollow(FOLLOW_word_in_classpath1897);
			w=word();
			state._fsp--;

			s = w;
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:213:52: ( POINT w1= word )+
			int cnt37=0;
			loop37:
			while (true) {
				int alt37=2;
				...
				switch (alt37) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:213:53: POINT w1= word
					{
					match(input,POINT,FOLLOW_POINT_in_classpath1902); 
					pushFollow(FOLLOW_word_in_classpath1906);
					w1=word();
					state._fsp--;
	...
	// $ANTLR start "word"
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:214:1: word returns [String s] : ( CONST | VAR ) ;
	public final String word() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:214:25: ( ( CONST | VAR ) )
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:214:27: ( CONST | VAR )
			{
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:214:27: ( CONST | VAR )
			int alt38=2;
			...
			switch (alt38) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:214:28: CONST
					{
					CONST1=(Token)match(input,CONST,FOLLOW_CONST_in_word2007); 
					s =CONST1.getText();
					}
					break;
				case 2 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:214:59: VAR
					{
					VAR2=(Token)match(input,VAR,FOLLOW_VAR_in_word2013); 
					s =VAR2.getText();
					}
					break;
	...
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:216:1: agentnameterm returns [Abstract_StringTerm s] : ( CONST |v= var );
	public final Abstract_StringTerm agentnameterm() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:216:47: ( CONST |v= var )
			int alt39=2;
			...
			switch (alt39) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:216:49: CONST
					{
					CONST3=(Token)match(input,CONST,FOLLOW_CONST_in_agentnameterm2113); 
					s = new Abstract_StringTermImpl(CONST3.getText());
					}
					break;
				case 2 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:216:111: v= var
					{
					pushFollow(FOLLOW_var_in_agentnameterm2121);
					v=var();
					state._fsp--;
	...
	// $ANTLR start "literal"
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:219:1: literal returns [Abstract_Literal l] : ( ( TRUE | NOT nt= pred ) |t= pred );
	public final Abstract_Literal literal() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:219:37: ( ( TRUE | NOT nt= pred ) |t= pred )
			int alt41=2;
			...
			switch (alt41) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:219:40: ( TRUE | NOT nt= pred )
					{
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:219:40: ( TRUE | NOT nt= pred )
					int alt40=2;
					...
					switch (alt40) {
						case 1 :
							// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:219:41: TRUE
							{
							match(input,TRUE,FOLLOW_TRUE_in_literal2137); 
							l = new Abstract_Literal(Abstract_Literal.LTrue);
							}
							break;
						case 2 :
							// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:220:5: NOT nt= pred
							{
							match(input,NOT,FOLLOW_NOT_in_literal2148); 
							pushFollow(FOLLOW_pred_in_literal2152);
							nt=pred();
							state._fsp--;
					...
					break;
				case 2 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:224:5: t= pred
					{
					pushFollow(FOLLOW_pred_in_literal2166);
					t=pred();
					state._fsp--;
	...
	// $ANTLR start "pred"
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:228:1: pred returns [Abstract_Predicate t] : (v= var |f= function );
	public final Abstract_Predicate pred() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:228:37: (v= var |f= function )
			int alt42=2;
			...
			switch (alt42) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:228:39: v= var
					{
					pushFollow(FOLLOW_var_in_pred2182);
					v=var();
					state._fsp--;
					...
					break;
				case 2 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:228:59: f= function
					{
					pushFollow(FOLLOW_function_in_pred2189);
					f=function();
					state._fsp--;
	...
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:229:1: function returns [Abstract_Predicate f] : CONST ( OPEN terms[$f] CLOSE )? ;
	public final Abstract_Predicate function() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:229:40: ( CONST ( OPEN terms[$f] CLOSE )? )
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:229:42: CONST ( OPEN terms[$f] CLOSE )?
			{
			CONST4=(Token)match(input,CONST,FOLLOW_CONST_in_function2201); 
			f = new Abstract_Predicate(CONST4.getText());
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:229:97: ( OPEN terms[$f] CLOSE )?
			int alt43=2;
			...
			switch (alt43) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:229:98: OPEN terms[$f] CLOSE
					{
					match(input,OPEN,FOLLOW_OPEN_in_function2206); 
					pushFollow(FOLLOW_terms_in_function2208);
					terms(f);
					state._fsp--;

					match(input,CLOSE,FOLLOW_CLOSE_in_function2211); 
					}
					break;
	...
	// $ANTLR start "terms"
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:231:1: terms[Abstract_Predicate f] : t= term ( COMMA terms[$f] )? ;
	public final void terms(Abstract_Predicate f) throws RecognitionException {
		Abstract_Term t =null;

		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:231:29: (t= term ( COMMA terms[$f] )? )
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:231:31: t= term ( COMMA terms[$f] )?
			{
			pushFollow(FOLLOW_term_in_terms2224);
			t=term();
			state._fsp--;

			f.addTerm(t);
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:231:58: ( COMMA terms[$f] )?
			int alt44=2;
			...
			switch (alt44) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:231:59: COMMA terms[$f]
					{
					match(input,COMMA,FOLLOW_COMMA_in_terms2229); 
					pushFollow(FOLLOW_terms_in_terms2231);
					terms(f);
					state._fsp--;
	...
	// $ANTLR start "term"
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:232:1: term returns [Abstract_Term t] : (a= atom |s= stringterm |f= function );
	public final Abstract_Term term() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:232:31: (a= atom |s= stringterm |f= function )
			int alt45=3;
			switch ( input.LA(1) ) {
			case MINUS:
			case NUMBER:
			...
			switch (alt45) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:232:34: a= atom
					{
					pushFollow(FOLLOW_atom_in_term2250);
					a=atom();
					state._fsp--;
					...
					break;
				case 2 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:232:58: s= stringterm
					{
					pushFollow(FOLLOW_stringterm_in_term2260);
					s=stringterm();
					state._fsp--;
					...
					break;
				case 3 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:232:88: f= function
					{
					pushFollow(FOLLOW_function_in_term2268);
					f=function();
					state._fsp--;
	...
	// $ANTLR start "atom"
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:234:1: atom returns [Abstract_NumberTerm t] : (n= numberstring |v= var | OPEN a= arithexpr CLOSE );
	public final Abstract_NumberTerm atom() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:234:38: (n= numberstring |v= var | OPEN a= arithexpr CLOSE )
			int alt46=3;
			switch ( input.LA(1) ) {
			case MINUS:
			case NUMBER:
			...
			switch (alt46) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:234:40: n= numberstring
					{
					pushFollow(FOLLOW_numberstring_in_atom2286);
					n=numberstring();
					state._fsp--;
					...
					break;
				case 2 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:235:6: v= var
					{
					pushFollow(FOLLOW_var_in_atom2299);
					v=var();
					state._fsp--;
					...
					break;
				case 3 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:235:27: OPEN a= arithexpr CLOSE
					{
					match(input,OPEN,FOLLOW_OPEN_in_atom2305); 
					pushFollow(FOLLOW_arithexpr_in_atom2309);
					a=arithexpr();
					state._fsp--;

					match(input,CLOSE,FOLLOW_CLOSE_in_atom2311); 
					t = a;
					}
					break;
	...
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:236:1: stringterm returns [Abstract_StringTerm s] : DOUBLEQUOTE STRING DOUBLEQUOTE ;
	public final Abstract_StringTerm stringterm() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:236:44: ( DOUBLEQUOTE STRING DOUBLEQUOTE )
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:236:46: DOUBLEQUOTE STRING DOUBLEQUOTE
			{
			match(input,DOUBLEQUOTE,FOLLOW_DOUBLEQUOTE_in_stringterm2324); 
			STRING5=(Token)match(input,STRING,FOLLOW_STRING_in_stringterm2327); 
			match(input,DOUBLEQUOTE,FOLLOW_DOUBLEQUOTE_in_stringterm2329); 
	...
	// $ANTLR start "var"
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:238:1: var returns [Abstract_VarTerm v] : VAR ;
	public final Abstract_VarTerm var() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:238:34: ( VAR )
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:238:36: VAR
			{
			VAR6=(Token)match(input,VAR,FOLLOW_VAR_in_var2343); 
	...
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:247:1: numberstring returns [String s] : ( MINUS )? (n1= NUMBER ( POINT n2= NUMBER )? ) ;
	public final String numberstring() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:247:33: ( ( MINUS )? (n1= NUMBER ( POINT n2= NUMBER )? ) )
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:247:35: ( MINUS )? (n1= NUMBER ( POINT n2= NUMBER )? )
			{
			s = "";
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:247:46: ( MINUS )?
			int alt47=2;
			...
			switch (alt47) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:247:47: MINUS
					{
					match(input,MINUS,FOLLOW_MINUS_in_numberstring2360); 
					s += "-";
					}
					break;
			...
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:247:68: (n1= NUMBER ( POINT n2= NUMBER )? )
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:247:69: n1= NUMBER ( POINT n2= NUMBER )?
			{
			n1=(Token)match(input,NUMBER,FOLLOW_NUMBER_in_numberstring2369); 
			s += n1.getText();
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:248:6: ( POINT n2= NUMBER )?
			int alt48=2;
			...
			switch (alt48) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:248:7: POINT n2= NUMBER
					{
					match(input,POINT,FOLLOW_POINT_in_numberstring2379); 
					s += ".";
					n2=(Token)match(input,NUMBER,FOLLOW_NUMBER_in_numberstring2385); 
					s += n2.getText();
					}
					break;
	...
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:249:1: equation returns [Abstract_Equation eq] : a1= arithexpr oper= eqoper a2= arithexpr ;
	public final Abstract_Equation equation() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:249:40: (a1= arithexpr oper= eqoper a2= arithexpr )
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:249:42: a1= arithexpr oper= eqoper a2= arithexpr
			{
			pushFollow(FOLLOW_arithexpr_in_equation2402);
			a1=arithexpr();
			state._fsp--;

			pushFollow(FOLLOW_eqoper_in_equation2406);
			oper=eqoper();
			state._fsp--;

			pushFollow(FOLLOW_arithexpr_in_equation2410);
			a2=arithexpr();
			state._fsp--;
	...
	// $ANTLR start "eqoper"
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:250:1: eqoper returns [int oper] : ( LESS | EQ );
	public final int eqoper() throws RecognitionException {
		int oper = 0;


		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:250:27: ( LESS | EQ )
			int alt49=2;
			...
			switch (alt49) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:250:29: LESS
					{
					match(input,LESS,FOLLOW_LESS_in_eqoper2424); 
					oper =Abstract_Equation.less;
					}
					break;
				case 2 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:250:68: EQ
					{
					match(input,EQ,FOLLOW_EQ_in_eqoper2430); 
	...
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:252:1: arithexpr returns [Abstract_NumberTerm t] : m= multexpr (oper= addoper m1= multexpr )? ;
	public final Abstract_NumberTerm arithexpr() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:252:43: (m= multexpr (oper= addoper m1= multexpr )? )
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:252:45: m= multexpr (oper= addoper m1= multexpr )?
			{
			pushFollow(FOLLOW_multexpr_in_arithexpr2446);
			m=multexpr();
			state._fsp--;

			t = m;
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:252:69: (oper= addoper m1= multexpr )?
			int alt50=2;
			...
			switch (alt50) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:252:71: oper= addoper m1= multexpr
					{
					pushFollow(FOLLOW_addoper_in_arithexpr2454);
					oper=addoper();
					state._fsp--;

					pushFollow(FOLLOW_multexpr_in_arithexpr2458);
					m1=multexpr();
					state._fsp--;
	...
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:253:1: multexpr returns [Abstract_NumberTerm t] : a= atom (oper= multoper a1= atom )? ;
	public final Abstract_NumberTerm multexpr() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:253:42: (a= atom (oper= multoper a1= atom )? )
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:253:44: a= atom (oper= multoper a1= atom )?
			{
			pushFollow(FOLLOW_atom_in_multexpr2475);
			a=atom();
			state._fsp--;

			t = a;
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:253:64: (oper= multoper a1= atom )?
			int alt51=2;
			...
			switch (alt51) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:253:65: oper= multoper a1= atom
					{
					pushFollow(FOLLOW_multoper_in_multexpr2482);
					oper=multoper();
					state._fsp--;

					pushFollow(FOLLOW_atom_in_multexpr2486);
					a1=atom();
					state._fsp--;
	...
	// $ANTLR start "addoper"
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:255:1: addoper returns [int oper] : ( PLUS | MINUS ) ;
	public final int addoper() throws RecognitionException {
		int oper = 0;


		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:255:28: ( ( PLUS | MINUS ) )
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:255:30: ( PLUS | MINUS )
			{
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:255:30: ( PLUS | MINUS )
			int alt52=2;
			...
			switch (alt52) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:255:31: PLUS
					{
					match(input,PLUS,FOLLOW_PLUS_in_addoper2503); 
					oper =Abstract_ArithExpr.plus;
					}
					break;
				case 2 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:255:70: MINUS
					{
					match(input,MINUS,FOLLOW_MINUS_in_addoper2508); 
	...
	// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:256:1: multoper returns [int oper] : ( MULT | DIV | MOD ) ;
	public final int multoper() throws RecognitionException {
		int oper = 0;


		try {
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:256:29: ( ( MULT | DIV | MOD ) )
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:256:31: ( MULT | DIV | MOD )
			{
			// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:256:31: ( MULT | DIV | MOD )
			int alt53=3;
			switch ( input.LA(1) ) {
			...
			switch (alt53) {
				case 1 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:256:32: MULT
					{
					...
					break;
				case 2 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:256:73: DIV
					{
					...
					break;
				case 3 :
					// /Users/lad/Eclipse/mcapl/src/classes/eass/parser/EASS.g:256:111: MOD
					{
					match(input,MOD,FOLLOW_MOD_in_multoper2535); 
	...
	public static final BitSet FOLLOW_CURLYOPEN_in_plan326 = new BitSet(new long[]{0x502009C208004400L});
	public static final BitSet FOLLOW_NOT_in_plan331 = new BitSet(new long[]{0x5020098208004400L});
	public static final BitSet FOLLOW_guard_atom_in_plan339 = new BitSet(new long[]{0x0000000000120000L});
	public static final BitSet FOLLOW_COMMA_in_plan347 = new BitSet(new long[]{0x502009C208004400L});
	public static final BitSet FOLLOW_NOT_in_plan352 = new BitSet(new long[]{0x5020098208004400L});
	...
	public static final BitSet FOLLOW_TRUE_in_guard_atom846 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_PLUS_in_deed870 = new BitSet(new long[]{0x5040084100080000L});
	public static final BitSet FOLLOW_literal_in_deed875 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_SHRIEK_in_deed885 = new BitSet(new long[]{0x5000004000080000L});
	public static final BitSet FOLLOW_goal_in_deed889 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_LOCK_in_deed899 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_PLAN_in_deed908 = new BitSet(new long[]{0x0000010000000000L});
	public static final BitSet FOLLOW_OPEN_in_deed910 = new BitSet(new long[]{0x4000000000080000L});
	public static final BitSet FOLLOW_pred_in_deed914 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_CLOSE_in_deed916 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_MINUS_in_deed929 = new BitSet(new long[]{0x5040084100080000L});
	public static final BitSet FOLLOW_literal_in_deed934 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_SHRIEK_in_deed944 = new BitSet(new long[]{0x5000004000080000L});
	public static final BitSet FOLLOW_goal_in_deed948 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_LOCK_in_deed958 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_PLAN_in_deed968 = new BitSet(new long[]{0x0000010000000000L});
	public static final BitSet FOLLOW_OPEN_in_deed970 = new BitSet(new long[]{0x4000000000080000L});
	public static final BitSet FOLLOW_pred_in_deed974 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_CLOSE_in_deed976 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_UPDATE_in_deed993 = new BitSet(new long[]{0x5000004000080000L});
	public static final BitSet FOLLOW_literal_in_deed998 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CALCULATE_in_deed1009 = new BitSet(new long[]{0x0000010000000000L});
	public static final BitSet FOLLOW_calculation_in_deed1013 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_QUERYCOM_in_deed1024 = new BitSet(new long[]{0x0000010000000000L});
	public static final BitSet FOLLOW_query_in_deed1028 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_WAIT_in_deed1039 = new BitSet(new long[]{0x0000010000000000L});
	public static final BitSet FOLLOW_wait_in_deed1043 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_action_in_deed1056 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_waitfor_in_deed1069 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_SUBSTITUTE_in_deed1079 = new BitSet(new long[]{0x0000010000000000L});
	public static final BitSet FOLLOW_substitution_in_deed1083 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_OPEN_in_substitution1114 = new BitSet(new long[]{0x4000000000080000L});
	public static final BitSet FOLLOW_pred_in_substitution1118 = new BitSet(new long[]{0x0000000000020000L});
	public static final BitSet FOLLOW_COMMA_in_substitution1120 = new BitSet(new long[]{0x4000000000080000L});
	public static final BitSet FOLLOW_pred_in_substitution1126 = new BitSet(new long[]{0x0000000000020000L});
	public static final BitSet FOLLOW_COMMA_in_substitution1128 = new BitSet(new long[]{0x4000000000080000L});
	public static final BitSet FOLLOW_pred_in_substitution1133 = new BitSet(new long[]{0x0000000000020000L});
	public static final BitSet FOLLOW_COMMA_in_substitution1135 = new BitSet(new long[]{0x4000000000080000L});
	public static final BitSet FOLLOW_pred_in_substitution1141 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_CLOSE_in_substitution1143 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_OPEN_in_calculation1163 = new BitSet(new long[]{0x5000004000080000L});
	public static final BitSet FOLLOW_literal_in_calculation1169 = new BitSet(new long[]{0x0000000000020000L});
	public static final BitSet FOLLOW_COMMA_in_calculation1171 = new BitSet(new long[]{0x4000000000000000L});
	public static final BitSet FOLLOW_var_in_calculation1175 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_CLOSE_in_calculation1177 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_OPEN_in_query1195 = new BitSet(new long[]{0x5000004000080000L});
	public static final BitSet FOLLOW_literal_in_query1201 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_CLOSE_in_query1204 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_OPEN_in_wait1222 = new BitSet(new long[]{0x4000018200880000L});
	public static final BitSet FOLLOW_term_in_wait1228 = new BitSet(new long[]{0x0000000000020000L});
	public static final BitSet FOLLOW_COMMA_in_wait1230 = new BitSet(new long[]{0x5000004000080000L});
	public static final BitSet FOLLOW_literal_in_wait1234 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_CLOSE_in_wait1236 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_pred_in_brule1258 = new BitSet(new long[]{0x0008000000000800L});
	public static final BitSet FOLLOW_BRULEARROW_in_brule1261 = new BitSet(new long[]{0x4000004000080000L});
	public static final BitSet FOLLOW_logicalfmla_in_brule1265 = new BitSet(new long[]{0x0008000000000000L});
	public static final BitSet FOLLOW_SEMI_in_brule1269 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_SEMI_in_brule1273 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_notfmla_in_logicalfmla1290 = new BitSet(new long[]{0x0000000000020002L});
	public static final BitSet FOLLOW_COMMA_in_logicalfmla1310 = new BitSet(new long[]{0x4000004000080000L});
	public static final BitSet FOLLOW_notfmla_in_logicalfmla1314 = new BitSet(new long[]{0x0000000000020002L});
	public static final BitSet FOLLOW_pred_in_notfmla1349 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_NOT_in_notfmla1434 = new BitSet(new long[]{0x4000010000080000L});
	public static final BitSet FOLLOW_pred_in_notfmla1441 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_subfmla_in_notfmla1451 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_OPEN_in_subfmla1465 = new BitSet(new long[]{0x4000004000080000L});
	public static final BitSet FOLLOW_logicalfmla_in_subfmla1471 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_CLOSE_in_subfmla1475 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_MULT_in_waitfor1489 = new BitSet(new long[]{0x5000004000080000L});
	public static final BitSet FOLLOW_literal_in_waitfor1493 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_atom_in_action1512 = new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_PLUS_in_action1514 = new BitSet(new long[]{0x4000018200000000L});
	public static final BitSet FOLLOW_atom_in_action1518 = new BitSet(new long[]{0x0000000004000000L});
	public static final BitSet FOLLOW_EQ_ASSGN_in_action1520 = new BitSet(new long[]{0x4000000000000000L});
	public static final BitSet FOLLOW_var_in_action1524 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_SEND_in_action1533 = new BitSet(new long[]{0x0000010000000000L});
	public static final BitSet FOLLOW_OPEN_in_action1535 = new BitSet(new long[]{0x5000004000080000L});
	public static final BitSet FOLLOW_literal_in_action1539 = new BitSet(new long[]{0x0000000000020000L});
	public static final BitSet FOLLOW_COMMA_in_action1541 = new BitSet(new long[]{0x0800020000000020L});
	public static final BitSet FOLLOW_performative_in_action1545 = new BitSet(new long[]{0x0000000000020000L});
	public static final BitSet FOLLOW_COMMA_in_action1547 = new BitSet(new long[]{0x4000000000080000L});
	public static final BitSet FOLLOW_pred_in_action1551 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_CLOSE_in_action1553 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_pred_in_action1564 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_TELL_in_performative1579 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_PERFORM_in_performative1585 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ACHIEVE_in_performative1591 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_classpath_in_environment1882 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_word_in_classpath1897 = new BitSet(new long[]{0x0000400000000000L});
	public static final BitSet FOLLOW_POINT_in_classpath1902 = new BitSet(new long[]{0x4000000000080000L});
	public static final BitSet FOLLOW_word_in_classpath1906 = new BitSet(new long[]{0x0000400000000002L});
	public static final BitSet FOLLOW_CONST_in_word2007 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_VAR_in_word2013 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CONST_in_agentnameterm2113 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_var_in_agentnameterm2121 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_TRUE_in_literal2137 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_NOT_in_literal2148 = new BitSet(new long[]{0x4000000000080000L});
	public static final BitSet FOLLOW_pred_in_literal2152 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_pred_in_literal2166 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_var_in_pred2182 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_function_in_pred2189 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CONST_in_function2201 = new BitSet(new long[]{0x0000010000000002L});
	public static final BitSet FOLLOW_OPEN_in_function2206 = new BitSet(new long[]{0x4000018200880000L});
	public static final BitSet FOLLOW_terms_in_function2208 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_CLOSE_in_function2211 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_term_in_terms2224 = new BitSet(new long[]{0x0000000000020002L});
	public static final BitSet FOLLOW_COMMA_in_terms2229 = new BitSet(new long[]{0x4000018200880000L});
	public static final BitSet FOLLOW_terms_in_terms2231 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_atom_in_term2250 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_stringterm_in_term2260 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_function_in_term2268 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_numberstring_in_atom2286 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_var_in_atom2299 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_OPEN_in_atom2305 = new BitSet(new long[]{0x4000018200000000L});
	public static final BitSet FOLLOW_arithexpr_in_atom2309 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_CLOSE_in_atom2311 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_DOUBLEQUOTE_in_stringterm2324 = new BitSet(new long[]{0x0200000000000000L});
	public static final BitSet FOLLOW_STRING_in_stringterm2327 = new BitSet(new long[]{0x0000000000800000L});
	public static final BitSet FOLLOW_DOUBLEQUOTE_in_stringterm2329 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_VAR_in_var2343 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_MINUS_in_numberstring2360 = new BitSet(new long[]{0x0000008000000000L});
	public static final BitSet FOLLOW_NUMBER_in_numberstring2369 = new BitSet(new long[]{0x0000400000000002L});
	public static final BitSet FOLLOW_POINT_in_numberstring2379 = new BitSet(new long[]{0x0000008000000000L});
	public static final BitSet FOLLOW_NUMBER_in_numberstring2385 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_arithexpr_in_equation2402 = new BitSet(new long[]{0x0000000042000000L});
	public static final BitSet FOLLOW_eqoper_in_equation2406 = new BitSet(new long[]{0x4000018200000000L});
	public static final BitSet FOLLOW_arithexpr_in_equation2410 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_LESS_in_eqoper2424 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_EQ_in_eqoper2430 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_multexpr_in_arithexpr2446 = new BitSet(new long[]{0x0000200200000002L});
	public static final BitSet FOLLOW_addoper_in_arithexpr2454 = new BitSet(new long[]{0x4000018200000000L});
	public static final BitSet FOLLOW_multexpr_in_arithexpr2458 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_atom_in_multexpr2475 = new BitSet(new long[]{0x0000000C00400002L});
	public static final BitSet FOLLOW_multoper_in_multexpr2482 = new BitSet(new long[]{0x4000018200000000L});
	public static final BitSet FOLLOW_atom_in_multexpr2486 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_PLUS_in_addoper2503 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_MINUS_in_addoper2508 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_MOD_in_multoper2535 = new BitSet(new long[]{0x0000000000000002L});
}
