function [X,lambda,how]=qpsub2(H,f,A,B,vlb,vub,X,neqcstr,verbosity,caller,ncstr,nvars)
...
%   $Revision: 1.13 $  $Date: 1997/11/29 01:23:23 $
...
if mc>eps
   ...
   [XS,lambdas] = qpsub2([],[zeros(nvars,1);1],A2,[B;1e-5], ...
