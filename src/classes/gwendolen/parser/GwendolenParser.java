...
public class GwendolenParser extends Parser {
	...
	public static final int
		...
		BELIEVE=47, GOAL=48, SENT=49, LOCK=50, CALCULATE=51, QUERYCOM=52, WAIT=53, 
		PL_ACHIEVEGOAL=54, PL_PERFORMGOAL=55, PL_SQOPEN=56, PL_SQCLOSE=57, PL_BAR=58, 
		NOT=59, COLON=60, CURLYOPEN=61, CURLYCLOSE=62, COMMA=63, SEMI=64, TELL=65, 
		SHRIEK=66, OPEN=67, CLOSE=68, MULT=69, PLUS=70, MINUS=71, LESS=72, EQUAL=73, 
		IDPUNCT=74, RULEARROW=75, TRUE=76, PL_CONST=77, PL_VAR=78, NUMBER=79, 
		QUOTED_STRING=80;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'.sent'", "'.lock'", "'.calculate'", "'.query'", "'.wait'", "'achieve'", 
			"'perform'", null, null, "'|'", "'~'", "':'", "'{'", "'}'", "','", "';'", 
			"':tell'", "'!'", "'('", "')'", "'*'", "'+'", "'-'", "'<'", "'=='", "'.'", 
			"'<-'", "'True'"
		};
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"LOCK", "CALCULATE", "QUERYCOM", "WAIT", "PL_ACHIEVEGOAL", "PL_PERFORMGOAL", 
			"PL_SQOPEN", "PL_SQCLOSE", "PL_BAR", "NOT", "COLON", "CURLYOPEN", "CURLYCLOSE", 
