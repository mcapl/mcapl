// $ANTLR 3.4 /Users/louiseadennis/Eclipse/mcapl/src/classes/goal/parser/GOAL.g 2013-12-11 13:51:27
...
public class GOALParser extends Parser {
        ...
        try {
            ...
            switch (alt29) {
                ...
                case 2 :
                    ...
                    Abstract_Goal gl = new Abstract_Goal(g); lf = gl;
    ...
    // /Users/louiseadennis/Eclipse/mcapl/src/classes/goal/parser/GOAL.g:112:1: actionspec[Abstract_GOALAgent gl] : deed= action[gl] CURLYOPEN PRE CURLYOPEN lf1= litconj CURLYCLOSE POST CURLYOPEN lf2= litconj CURLYCLOSE CURLYCLOSE ;
    public final void actionspec(Abstract_GOALAgent gl) throws RecognitionException {
        ...
        try {
            // /Users/louiseadennis/Eclipse/mcapl/src/classes/goal/parser/GOAL.g:112:34: (deed= action[gl] CURLYOPEN PRE CURLYOPEN lf1= litconj CURLYCLOSE POST CURLYOPEN lf2= litconj CURLYCLOSE CURLYCLOSE )
            // /Users/louiseadennis/Eclipse/mcapl/src/classes/goal/parser/GOAL.g:112:36: deed= action[gl] CURLYOPEN PRE CURLYOPEN lf1= litconj CURLYCLOSE POST CURLYOPEN lf2= litconj CURLYCLOSE CURLYCLOSE
            {
            pushFollow(FOLLOW_action_in_actionspec1351);
            deed=action(gl);
            ...
            match(input,PRE,FOLLOW_PRE_in_actionspec1360); 

            match(input,CURLYOPEN,FOLLOW_CURLYOPEN_in_actionspec1362); 
            ...
            match(input,POST,FOLLOW_POST_in_actionspec1373); 

            match(input,CURLYOPEN,FOLLOW_CURLYOPEN_in_actionspec1375); 

            pushFollow(FOLLOW_litconj_in_actionspec1379);
            lf2=litconj();

            state._fsp--;


            match(input,CURLYCLOSE,FOLLOW_CURLYCLOSE_in_actionspec1381); 

            match(input,CURLYCLOSE,FOLLOW_CURLYCLOSE_in_actionspec1383); 

            gl.addPlan(new Abstract_ActionSpec(goal, guard, lf2));
    ...
    // /Users/louiseadennis/Eclipse/mcapl/src/classes/goal/parser/GOAL.g:122:1: actioncombo[Abstract_GOALAgent gl] returns [ArrayList<Abstract_Deed> dl] :a= action[gl] ( PLUS a1= action[gl] )* ;
    public final ArrayList<Abstract_Deed> actioncombo(Abstract_GOALAgent gl) throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_action_in_actioncombo1403);
            a=action(gl);
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    match(input,PLUS,FOLLOW_PLUS_in_actioncombo1409); 

            	    pushFollow(FOLLOW_action_in_actioncombo1413);
            	    a1=action(gl);
    ...
    // $ANTLR start "action"
    // /Users/louiseadennis/Eclipse/mcapl/src/classes/goal/parser/GOAL.g:125:1: action[Abstract_GOALAgent gl] returns [Abstract_Deed d] : (deed= userdefaction | builtinaction | communication[gl] ) ;
    public final Abstract_Deed action(Abstract_GOALAgent gl) throws RecognitionException {
        ...
        try {
            ...
            // /Users/louiseadennis/Eclipse/mcapl/src/classes/goal/parser/GOAL.g:125:59: (deed= userdefaction | builtinaction | communication[gl] )
            {
            // /Users/louiseadennis/Eclipse/mcapl/src/classes/goal/parser/GOAL.g:125:59: (deed= userdefaction | builtinaction | communication[gl] )
            int alt31=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt31) {
                case 1 :
                    // /Users/louiseadennis/Eclipse/mcapl/src/classes/goal/parser/GOAL.g:125:60: deed= userdefaction
                    {
                    pushFollow(FOLLOW_userdefaction_in_action1435);
                    deed=userdefaction();
                    ...
                    break;
                case 2 :
                    // /Users/louiseadennis/Eclipse/mcapl/src/classes/goal/parser/GOAL.g:125:91: builtinaction
                    {
                    pushFollow(FOLLOW_builtinaction_in_action1440);
                    builtinaction();
                    ...
                    break;
                case 3 :
                    // /Users/louiseadennis/Eclipse/mcapl/src/classes/goal/parser/GOAL.g:125:154: communication[gl]
                    {
                    pushFollow(FOLLOW_communication_in_action1446);
                    communication(gl);
    ...
    public final Abstract_Deed userdefaction() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_id_in_userdefaction1466);
            f=id();
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_parameters_in_userdefaction1473);
            	    pl=parameters();
        ...
        try {
            ...
            switch (alt33) {
                case 1 :
                    ...
                    {
                    match(input,INSERT,FOLLOW_INSERT_in_builtinaction1490); 

                    match(input,OPEN,FOLLOW_OPEN_in_builtinaction1492); 

                    pushFollow(FOLLOW_litconj_in_builtinaction1494);
                    litconj();

                    state._fsp--;


                    match(input,CLOSE,FOLLOW_CLOSE_in_builtinaction1496); 
                ...
                case 2 :
                    ...
                    {
                    match(input,DELETE,FOLLOW_DELETE_in_builtinaction1502); 
                ...
                case 3 :
                    ...
                    {
                    match(input,ADOPT,FOLLOW_ADOPT_in_builtinaction1515); 

                    match(input,OPEN,FOLLOW_OPEN_in_builtinaction1517); 

                    pushFollow(FOLLOW_litconj_in_builtinaction1519);
                    litconj();

                    state._fsp--;


                    match(input,CLOSE,FOLLOW_CLOSE_in_builtinaction1521); 
                ...
                case 4 :
                    ...
                    {
                    match(input,DROP,FOLLOW_DROP_in_builtinaction1528); 

                    match(input,OPEN,FOLLOW_OPEN_in_builtinaction1530); 

                    pushFollow(FOLLOW_litconj_in_builtinaction1532);
                    litconj();

                    state._fsp--;


                    match(input,CLOSE,FOLLOW_CLOSE_in_builtinaction1534); 
    ...
    // /Users/louiseadennis/Eclipse/mcapl/src/classes/goal/parser/GOAL.g:136:1: communication[Abstract_GOALAgent gl] returns [Abstract_Deed d] : SEND OPEN id COMMA poslitconj[gl] CLOSE ;
    public final Abstract_Deed communication(Abstract_GOALAgent gl) throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,SEND,FOLLOW_SEND_in_communication1551); 

            match(input,OPEN,FOLLOW_OPEN_in_communication1553); 

            pushFollow(FOLLOW_id_in_communication1555);
            id();

            state._fsp--;


            match(input,COMMA,FOLLOW_COMMA_in_communication1557); 

            pushFollow(FOLLOW_poslitconj_in_communication1559);
            poslitconj(gl);

            state._fsp--;


            match(input,CLOSE,FOLLOW_CLOSE_in_communication1562); 
        ...
        try {
            ...
            switch (alt34) {
                case 1 :
                    ...
                    {
                    CONST1=(Token)match(input,CONST,FOLLOW_CONST_in_id1616); 
    ...
    public final Abstract_Equation equation() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_arithexpr_in_equation1943);
            a1=arithexpr();

            state._fsp--;


            pushFollow(FOLLOW_eqoper_in_equation1947);
            i=eqoper();

            state._fsp--;


            pushFollow(FOLLOW_arithexpr_in_equation1951);
            a2=arithexpr();
        ...
        try {
            ...
            switch (alt35) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_stringterm_in_term1968);
                    st=stringterm();
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_function_term_in_term1976);
                    ft=function_term();
                ...
                case 3 :
                    ...
                    {
                    pushFollow(FOLLOW_arithexpr_in_term1984);
                    at=arithexpr();
                ...
                case 4 :
                    ...
                    {
                    pushFollow(FOLLOW_listterm_in_term1991);
                    lt=listterm();
    ...
    public final Abstract_Term function_term() throws RecognitionException {
        ...
        try {
            ...
            {
            c=(Token)match(input,CONST,FOLLOW_CONST_in_function_term2011); 
            ...
            switch (alt37) {
                case 1 :
                    ...
                    {
                    match(input,OPEN,FOLLOW_OPEN_in_function_term2016); 

                    pushFollow(FOLLOW_term_in_function_term2020);
                    t1=term();
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    match(input,COMMA,FOLLOW_COMMA_in_function_term2025); 

                    	    pushFollow(FOLLOW_term_in_function_term2029);
                    	    t2=term();
                    ...
                    match(input,CLOSE,FOLLOW_CLOSE_in_function_term2035); 
        ...
        try {
            ...
            switch (alt38) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_numberstring_in_atom_term2054);
                    n=numberstring();
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_var_in_atom_term2062);
                    v=var();
    ...
    public final Abstract_StringTerm stringterm() throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,DOUBLEQUOTE,FOLLOW_DOUBLEQUOTE_in_stringterm2079); 

            pushFollow(FOLLOW_word_in_stringterm2083);
            w=word();

            state._fsp--;


            match(input,DOUBLEQUOTE,FOLLOW_DOUBLEQUOTE_in_stringterm2085); 
    ...
    public final Abstract_VarTerm var() throws RecognitionException {
        ...
        try {
            ...
            {
            VAR3=(Token)match(input,VAR,FOLLOW_VAR_in_var2099); 
        ...
        try {
            ...
            switch (alt39) {
                case 1 :
                    ...
                    {
                    match(input,MINUS,FOLLOW_MINUS_in_numberstring2119); 
            ...
            {
            n1=(Token)match(input,NUMBER,FOLLOW_NUMBER_in_numberstring2128); 
            ...
            switch (alt40) {
                case 1 :
                    ...
                    {
                    match(input,STOP,FOLLOW_STOP_in_numberstring2169); 

                    s += ".";

                    n2=(Token)match(input,NUMBER,FOLLOW_NUMBER_in_numberstring2175); 
    ...
    public final Abstract_NumberTerm arithexpr() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_multexpr_in_arithexpr2229);
            a1=multexpr();
            ...
            switch (alt41) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_addoper_in_arithexpr2236);
                    i=addoper();
    ...
    public final Abstract_NumberTerm multexpr() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_atom_term_in_multexpr2256);
            a1=atom_term();
            ...
            switch (alt42) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_multoper_in_multexpr2262);
                    i=multoper();

                    state._fsp--;


                    pushFollow(FOLLOW_atom_term_in_multexpr2266);
                    a2=atom_term();
        ...
        try {
            ...
            switch (alt43) {
                case 1 :
                    ...
                    {
                    CONST4=(Token)match(input,CONST,FOLLOW_CONST_in_word2283); 
                ...
                case 2 :
                    ...
                    {
                    VAR5=(Token)match(input,VAR,FOLLOW_VAR_in_word2289); 
    ...
    public final Abstract_ListTermImpl listterm() throws RecognitionException {
        ...
        try {
            ...
            match(input,SQOPEN,FOLLOW_SQOPEN_in_listterm2399); 
            ...
            switch (alt46) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_term_in_listterm2404);
                    h=term();
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    match(input,COMMA,FOLLOW_COMMA_in_listterm2412); 

                    	    pushFollow(FOLLOW_term_in_listterm2416);
                    	    t=term();
                    ...
                    switch (alt45) {
                        case 1 :
                            ...
                            {
                            match(input,BAR,FOLLOW_BAR_in_listterm2426); 

                            v=(Token)match(input,VAR,FOLLOW_VAR_in_listterm2430); 
            ...
            match(input,SQCLOSE,FOLLOW_SQCLOSE_in_listterm2439); 
        ...
        try {
            ...
            switch (alt47) {
                case 1 :
                    ...
                    {
                    match(input,PLUS,FOLLOW_PLUS_in_addoper2454); 
                ...
                case 2 :
                    ...
                    {
                    match(input,MINUS,FOLLOW_MINUS_in_addoper2460); 
        ...
        try {
            ...
            switch (alt48) {
                case 1 :
                    ...
                    {
                    match(input,MULT,FOLLOW_MULT_in_multoper2479); 
                ...
                case 2 :
                    ...
                    {
                    match(input,DIV,FOLLOW_DIV_in_multoper2485); 
        ...
        try {
            ...
            switch (alt49) {
                case 1 :
                    ...
                    {
                    match(input,LESS,FOLLOW_LESS_in_eqoper2502); 
                ...
                case 2 :
                    ...
                    {
                    match(input,EQUALS,FOLLOW_EQUALS_in_eqoper2508); 
    ...
    public static final BitSet FOLLOW_action_in_actionspec1351 = new BitSet(new long[]{0x0000000000008000L});
    public static final BitSet FOLLOW_CURLYOPEN_in_actionspec1358 = new BitSet(new long[]{0x0000100000000000L});
    public static final BitSet FOLLOW_PRE_in_actionspec1360 = new BitSet(new long[]{0x0000000000008000L});
    public static final BitSet FOLLOW_CURLYOPEN_in_actionspec1362 = new BitSet(new long[]{0x008000C400002000L});
    public static final BitSet FOLLOW_litconj_in_actionspec1366 = new BitSet(new long[]{0x0000000000004000L});
    public static final BitSet FOLLOW_CURLYCLOSE_in_actionspec1368 = new BitSet(new long[]{0x0000080000000000L});
    public static final BitSet FOLLOW_POST_in_actionspec1373 = new BitSet(new long[]{0x0000000000008000L});
    public static final BitSet FOLLOW_CURLYOPEN_in_actionspec1375 = new BitSet(new long[]{0x008000C400002000L});
    public static final BitSet FOLLOW_litconj_in_actionspec1379 = new BitSet(new long[]{0x0000000000004000L});
    public static final BitSet FOLLOW_CURLYCLOSE_in_actionspec1381 = new BitSet(new long[]{0x0000000000004000L});
    public static final BitSet FOLLOW_CURLYCLOSE_in_actionspec1383 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_action_in_actioncombo1403 = new BitSet(new long[]{0x0000040000000002L});
    public static final BitSet FOLLOW_PLUS_in_actioncombo1409 = new BitSet(new long[]{0x0082000008122020L});
    public static final BitSet FOLLOW_action_in_actioncombo1413 = new BitSet(new long[]{0x0000040000000002L});
    public static final BitSet FOLLOW_userdefaction_in_action1435 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_builtinaction_in_action1440 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_communication_in_action1446 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_id_in_userdefaction1466 = new BitSet(new long[]{0x0000010000000000L});
    public static final BitSet FOLLOW_parameters_in_userdefaction1473 = new BitSet(new long[]{0x0000010000000002L});
    public static final BitSet FOLLOW_INSERT_in_builtinaction1490 = new BitSet(new long[]{0x0000010000000000L});
    public static final BitSet FOLLOW_OPEN_in_builtinaction1492 = new BitSet(new long[]{0x008000C400002000L});
    public static final BitSet FOLLOW_litconj_in_builtinaction1494 = new BitSet(new long[]{0x0000000000000200L});
    public static final BitSet FOLLOW_CLOSE_in_builtinaction1496 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_DELETE_in_builtinaction1502 = new BitSet(new long[]{0x0000010000000000L});
    ...
    public static final BitSet FOLLOW_ADOPT_in_builtinaction1515 = new BitSet(new long[]{0x0000010000000000L});
    public static final BitSet FOLLOW_OPEN_in_builtinaction1517 = new BitSet(new long[]{0x008000C400002000L});
    public static final BitSet FOLLOW_litconj_in_builtinaction1519 = new BitSet(new long[]{0x0000000000000200L});
    public static final BitSet FOLLOW_CLOSE_in_builtinaction1521 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_DROP_in_builtinaction1528 = new BitSet(new long[]{0x0000010000000000L});
    public static final BitSet FOLLOW_OPEN_in_builtinaction1530 = new BitSet(new long[]{0x008000C400002000L});
    public static final BitSet FOLLOW_litconj_in_builtinaction1532 = new BitSet(new long[]{0x0000000000000200L});
    public static final BitSet FOLLOW_CLOSE_in_builtinaction1534 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_SEND_in_communication1551 = new BitSet(new long[]{0x0000010000000000L});
    public static final BitSet FOLLOW_OPEN_in_communication1553 = new BitSet(new long[]{0x0080000000002000L});
    public static final BitSet FOLLOW_id_in_communication1555 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_COMMA_in_communication1557 = new BitSet(new long[]{0x0080008400002000L});
    public static final BitSet FOLLOW_poslitconj_in_communication1559 = new BitSet(new long[]{0x0000000000000200L});
    public static final BitSet FOLLOW_CLOSE_in_communication1562 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_CONST_in_id1616 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_VAR_in_id1621 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_arithexpr_in_equation1943 = new BitSet(new long[]{0x0000000020200000L});
    public static final BitSet FOLLOW_eqoper_in_equation1947 = new BitSet(new long[]{0x0080008400000000L});
    public static final BitSet FOLLOW_arithexpr_in_equation1951 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_stringterm_in_term1968 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_function_term_in_term1976 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_arithexpr_in_term1984 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_listterm_in_term1991 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_CONST_in_function_term2011 = new BitSet(new long[]{0x0000010000000002L});
    public static final BitSet FOLLOW_OPEN_in_function_term2016 = new BitSet(new long[]{0x0088008400082000L});
    public static final BitSet FOLLOW_term_in_function_term2020 = new BitSet(new long[]{0x0000000000000A00L});
    public static final BitSet FOLLOW_COMMA_in_function_term2025 = new BitSet(new long[]{0x0088008400082000L});
    public static final BitSet FOLLOW_term_in_function_term2029 = new BitSet(new long[]{0x0000000000000A00L});
    public static final BitSet FOLLOW_CLOSE_in_function_term2035 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_numberstring_in_atom_term2054 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_var_in_atom_term2062 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_DOUBLEQUOTE_in_stringterm2079 = new BitSet(new long[]{0x0080000000002000L});
    public static final BitSet FOLLOW_word_in_stringterm2083 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_DOUBLEQUOTE_in_stringterm2085 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_VAR_in_var2099 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_MINUS_in_numberstring2119 = new BitSet(new long[]{0x0000008000000000L});
    public static final BitSet FOLLOW_NUMBER_in_numberstring2128 = new BitSet(new long[]{0x0010000000000002L});
    public static final BitSet FOLLOW_STOP_in_numberstring2169 = new BitSet(new long[]{0x0000008000000000L});
    public static final BitSet FOLLOW_NUMBER_in_numberstring2175 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_multexpr_in_arithexpr2229 = new BitSet(new long[]{0x0000040400000002L});
    public static final BitSet FOLLOW_addoper_in_arithexpr2236 = new BitSet(new long[]{0x0080008400000000L});
    public static final BitSet FOLLOW_multexpr_in_arithexpr2240 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_atom_term_in_multexpr2256 = new BitSet(new long[]{0x0000001000040002L});
    public static final BitSet FOLLOW_multoper_in_multexpr2262 = new BitSet(new long[]{0x0080008400000000L});
    public static final BitSet FOLLOW_atom_term_in_multexpr2266 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_CONST_in_word2283 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_VAR_in_word2289 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_SQOPEN_in_listterm2399 = new BitSet(new long[]{0x008C008400082000L});
    public static final BitSet FOLLOW_term_in_listterm2404 = new BitSet(new long[]{0x0004000000000840L});
    public static final BitSet FOLLOW_COMMA_in_listterm2412 = new BitSet(new long[]{0x0088008400082000L});
    public static final BitSet FOLLOW_term_in_listterm2416 = new BitSet(new long[]{0x0004000000000840L});
    public static final BitSet FOLLOW_BAR_in_listterm2426 = new BitSet(new long[]{0x0080000000000000L});
    public static final BitSet FOLLOW_VAR_in_listterm2430 = new BitSet(new long[]{0x0004000000000000L});
    public static final BitSet FOLLOW_SQCLOSE_in_listterm2439 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_PLUS_in_addoper2454 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_MINUS_in_addoper2460 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_MULT_in_multoper2479 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_DIV_in_multoper2485 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LESS_in_eqoper2502 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EQUALS_in_eqoper2508 = new BitSet(new long[]{0x0000000000000002L});
