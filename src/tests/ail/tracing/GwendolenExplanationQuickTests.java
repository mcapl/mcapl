...
public class GwendolenExplanationQuickTests {
	...
	@Test public void whyBeliefCreated() {
		...
		String s = "Belief \"the robot is at [1,1]\" was believed in state 36 because the belief <font face=\"Courier New\">&quot;the robot is at [1,1]&quot;</font> was added because Intention 2: add \"the robot is at [1,1]\" was created in state 24 because \"the robot is at [1,1]\" was perceived";
	...
	@Test public void whyInitialGoal() {
		...
		String s = "rubble(2,2) was a goal in state 10 because Event: added the goal achieve rubble(2,2) was posted in state 9 because Intention 1: add the goal achieve rubble(2,2) was created in state 3 because add the goal achieve rubble(2,2) was an initial goal.";
		String s2 = reason.getExplanation(ExplanationLevel.FINE, whys.getDescriptions());
		// System.err.println(s2);
		Boolean b = s2.equals(s);
		assertTrue(b);
	...
	@Test public void whySubGoal() {
		...
		String s = "\"the robot is holding rubble\" was a goal in state 37 because Event: added the goal achieve \"the robot is holding rubble\" was posted in state 37 because <font face=\"Courier New\">Plan 1: in response to the event: added the goal achieve rubble(2,2) do add the goal achieve &quot;the robot is holding rubble&quot; AND move_to(2,2) AND drop</font> was selected in state 13 because  the event <font face=\"Courier New\">added the goal achieve rubble(2,2)</font> was posted  in state 9";
		String s2 = reason.getExplanation(ExplanationLevel.FINE, whys.getDescriptions());
		//System.err.println(s2);
		Boolean b = s2.equals(s);
		assertTrue(b);
	...
	@Test public void whyAddInitialGoal() {
		...
		String s = "Event: added the goal achieve rubble(2,2) was posted in state 9 because Intention 1: add the goal achieve rubble(2,2) was created in state 3 because add the goal achieve rubble(2,2) was an initial goal.";
	...
	@Test public void whyAddSubGoal() {
		...
		String s = "Event: added the goal achieve \"the robot is holding rubble\" was posted in state 126 because <font face=\"Courier New\">Plan 1: in response to the event: added the goal achieve rubble(2,2) do add the goal achieve &quot;the robot is holding rubble&quot; AND move_to(2,2) AND drop</font> was selected in state 13 because  the event <font face=\"Courier New\">added the goal achieve rubble(2,2)</font> was posted  in state 9";
		String s2 = mir.getExplanation(ExplanationLevel.FINE, whys.getDescriptions());
		// System.err.println(s2);
		Boolean b = s2.equals(s);
		assertTrue(b);
	...
	@Test public void whyAction() {
		...
		String s = "<font face=\"Courier New\">drop</font> was executed because <font face=\"Courier New\">Plan 1: in response to the event: added the goal achieve rubble(2,2) do add the goal achieve &quot;the robot is holding rubble&quot; AND move_to(2,2) AND drop</font> was selected in state 13 because  the event <font face=\"Courier New\">added the goal achieve rubble(2,2)</font> was posted  in state 9";
		String s2 = reason.getExplanation(ExplanationLevel.FINE, whys.getDescriptions());
		// System.err.println(s2);
		Boolean b = s2.equals(s);
		assertTrue(b);
	...
	@Test public void whyCreateIStart() {
		...
		String s = "Intention 1: add the goal achieve rubble(2,2) was created in state 3 because add the goal achieve rubble(2,2) was an initial goal.";
