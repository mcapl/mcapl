...
You will find a \gwendolen\ program in the tutorial directory called \texttt{pickuprubble\_achieve.gwen}.  Its contents should look like Example~\ref{code:pickuprubble_achieve}.
\begin{ourexample}
