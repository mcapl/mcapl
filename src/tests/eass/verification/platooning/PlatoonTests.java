 ...
 *
 */
public class PlatoonTests extends TestJPF {
	 static final String[] ARGS = {};
	
	  @Test //----------------------------------------------------------------------
	  public void req_1_1() {
		  if (verifyNoPropertyViolation(ARGS)) {
		    	String filename =  "/src/examples/eass/verification/platoon/platoon.ail";
		    	String prop_filename =  "/src/examples/eass/verification/platoon/platoon.psl";
		    	String[] args = new String[3];
		    	args[0] = filename;
		    	args[1] = prop_filename;
		    	args[2] = "req1_1_verified_prop3_in_paper";
		    	AJPF_w_AIL.run(args);
		  } else {
