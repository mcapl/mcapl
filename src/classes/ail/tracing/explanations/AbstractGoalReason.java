...
/**
 * Largely superfluous class since it duplicates AbstractReason but
 * establishes an expectation that BDI languages should be able to explain
 * why they have a goal.
 * @author louisedennis
 *
 */
