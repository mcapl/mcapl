...
Eclipse \texttt{run-AIL}\index{run-AIL} configuration
(with \texttt{hello\_world.ail} selected in the Package Explorer
...
\item Experiment getting the program to print out various different
  ...
  (i.e. \lstinline{print("hello
    world");})\index{example!hello\_world}\index{action!print!whitespace}\index{action!print}
\end{enumerate}
