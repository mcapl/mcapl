...
public interface Abstract_Property {
	/**
	 * Convert this property to a concrete property for use in the JPF JVM.
	 * @param mas
	 * @param c
	 * @return
	 */
	...
	/**
	 * Convert this property to a concrete property for use int he Native JVM.
	 * @return
	 */
	public MCAPLProperty toMCAPLNative();
	
	/**
	 * Recreate this abstract property in the JPF JVM.
	 * @param env
	 * @return
	 */
	...
	/**
	 * Convert this property to a normal form where all the "not"s are innermost.
	 * @return
	 */
