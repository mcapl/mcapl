...
import ajpf.psl.MCAPLAgIntendToDo;
...
/**
 * Abstract class for Intend to do formulae.
 * 
 * @author louiseadennis
 * 
 */
public class Abstract_AgIntendToDo extends Abstract_Proposition {
	 ...
	 * @param f  The goal.
	 */
	public Abstract_AgIntendToDo(String a, Abstract_Formula f) {
		action = f;
		agent = a;
	}
	...
	public MCAPLProperty toMCAPL(MCAPLmas mas, MCAPLcontroller c) {
		return new MCAPLAgIntendToDo(c.getAgent(agent), (MCAPLFormula) action.toMCAPL());
	}
	...
	public int newJPFObject(MJIEnv env) {
		int ref = env.newObject("ajpf.psl.ast.Abstract_AgIntendToDo");
