...
public class I2CSensor implements SensorConstants {
	...
	public I2CSensor(I2CPort port, NXTCommand nxtC)
	{
        this(port, DEFAULT_I2C_ADDRESS, I2CPort.LEGO_MODE, TYPE_LOWSPEED, nxtC);
    }
	 ...
	 */
	public I2CSensor(I2CPort port, int mode, NXTCommand nxtC)
	{
		this(port, DEFAULT_I2C_ADDRESS, mode, TYPE_LOWSPEED, nxtC);
	}
	 ...
	 * @param type
	 */
	public I2CSensor(I2CPort port, int address, int mode, int type, NXTCommand nxtC)
	{
		port.setTypeAndMode(type, NXTProtocol.RAWMODE);
		this.port = (byte)port.getId();
        this.address = address;
        this.nxtCommand = nxtC;
