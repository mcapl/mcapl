...
public class LogExpr implements LogicalFormula {
	 ...
	 */
    public Iterator<Unifier> logicalConsequence(final EvaluationBasewNames<? extends PredicateTerm> eb, final RuleBase rb, Unifier un, final List<String> varnames) {
        try {
