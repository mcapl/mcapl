...
This tutorial assumes familiarity with the operation of \ajpf\ as described \intutorial{\ajpf}{1}{tutorial:ajpf:psl} and \intutorial{\apjf}{2}{tutorial:ajpf:troubleshooting} and familiarity with the theory of model checking.  Unlike most tutorials, this tutorial is not standalone and assumes the user has access to both \spin\ and \prism\index{SPIN}\index{Prism}.
