...
public class Abstract_JunoActionRule {
	Abstract_Literal trigger;
	Abstract_Literal[] beliefs = new Abstract_Literal[0];
	
	
	public Abstract_JunoActionRule(Abstract_Literal trigger) {
	...
	public JunoActionRule toMCAPL() {
		JunoActionRule rule = new JunoActionRule(trigger.toMCAPL());
	...
	public int newJPFObject(MJIEnv env) {
		int objref = env.newObject("juno.syntax.ast.Abstract_JunoActionRule");
