...
/**
 * Formula representing an intervention.  See Bentzen and Lindner's papers for more detail.
 * @author louisedennis
 *
 */
public class Intervention extends Formula {
	public Intervention(Formula f1, Formula f2) {
		super(f1, f2);
	}
}
