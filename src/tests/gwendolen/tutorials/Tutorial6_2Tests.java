 ...
 */
public class Tutorial6_2Tests extends TestJPF {
  ...
  @Test //----------------------------------------------------------------------
  public void pickuprubble_lockex () {
    if (verifyNoPropertyViolation(JPF_ARGS)){
    	String filename =  "/src/examples/gwendolen/tutorials/tutorial6/answers/pickuprubble_lock.ail";
