...
/**
 * Add an agent to the Context set of the agent.
 * 
 * @author lad
 *
 */
public class HandleAddContext extends HandleContext {
	private static final String name = "Handle Add Context";
	...
	public void apply(AILAgent a) {
		...
		context_term.apply(thetahd);
		String st = context_term.toString();
