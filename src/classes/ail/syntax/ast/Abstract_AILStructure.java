...
/**
 * Abstract version of the interface class for the various AIL specific structures such as deeds, events
...
public interface Abstract_AILStructure {
	...
	/**
	 * Create an AILStructure from this Abstract version.
	 * @return
	 */
	public AILStructure toMCAPL();
	
	/**
	 * Create a copy of this structure in the JPF virtual machine.
	 * @param env
	 * @return
	 */
