...
public class GwendolenParser extends Parser {
	...
	public static final int
		PLANS=5, LOCK=12, CLOSE=26, SQCLOSE=30, PERFORMGOAL=19, COMMENT=32, RECEIVED=8, 
		ACHIEVE=17, PERFORM=16, SQOPEN=29, COMMASEP=27, TELL=15, CONST=23, ADD_PLAN=13, 
		BRULEARROW=20, WS=35, GWENDOLEN=1, BELIEVE=9, IDPUNCT=28, BELIEFRULES=4, 
		ADD_CONSTRAINT=14, NEWLINE=34, TRUE=22, RULEARROW=21, GOALS=2, SEND=7, 
		NAME=6, OPEN=25, GOAL=10, BAR=31, LINE_COMMENT=33, BELIEFS=3, SENT=11, 
		ACHIEVEGOAL=18, QUOTED_STRING=24, COMMA=36, COLON=37, CURLYOPEN=38, CURLYCLOSE=39, 
		SEMI=40, NOT=41, PLUS=42, SHRIEK=43, MINUS=44, MULT=45, POINT=46, VAR=47, 
		UNNAMEDVAR=48;
	public static final String[] tokenNames = {
		"<INVALID>", "'GWENDOLEN'", "':Initial Goals:'", "':Initial Beliefs:'", 
		"':Reasoning Rules:'", "':Plans:'", "':name:'", "'.send'", "'.received'", 
		"BELIEVE", "GOAL", "'.sent'", "'.lock'", "'.plan'", "'.constraint'", "':tell'", 
		"':perform'", "':achieve'", "'achieve'", "'perform'", "':-'", "'<-'", 
		"'True'", "CONST", "QUOTED_STRING", "'('", "')'", "','", "'.'", "'['", 
		"']'", "'|'", "COMMENT", "LINE_COMMENT", "NEWLINE", "WS", "COMMA", "COLON", 
		"CURLYOPEN", "CURLYCLOSE", "SEMI", "NOT", "PLUS", "SHRIEK", "MINUS", "MULT", 
		"POINT", "VAR", "UNNAMEDVAR"
	};
	public static final int
	...
	public final MasContext mas() throws RecognitionException {
		...
		try {
			...
			{
			setState(36); ((MasContext)_localctx).glist = gwendolenagents();
			}
		}
	...
	public final GwendolenagentsContext gwendolenagents() throws RecognitionException {
		...
		try {
			...
			do {
				{
				{
				setState(39); ((GwendolenagentsContext)_localctx).g = gwendolenagent();
				}
				}
				setState(42); 
				_errHandler.sync(this);
	...
	public final GwendolenagentContext gwendolenagent() throws RecognitionException {
		...
		try {
			...
			if (_la==GWENDOLEN) {
				{
				setState(44); match(GWENDOLEN);
				}
			}

			}
			setState(47); match(NAME);
			setState(48); ((GwendolenagentContext)_localctx).w = word();
			setState(49); match(BELIEFS);
			setState(53);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==CONST || _la==SQOPEN) {
				{
				{
				setState(50); ((GwendolenagentContext)_localctx).l = fof_expr();
				}
				}
				setState(55);
				_errHandler.sync(this);
			...
			if (_la==BELIEFRULES) {
				...
				while (_la==CONST || _la==SQOPEN) {
					{
					{
					setState(57); ((GwendolenagentContext)_localctx).r = brule();
					}
					}
					setState(62);
					_errHandler.sync(this);
			...
			while (_la==CONST || _la==SQOPEN) {
				{
				{
				setState(66); ((GwendolenagentContext)_localctx).gl = goal();
				}
				}
				setState(71);
				_errHandler.sync(this);
			...
			while (_la==PLUS || _la==MINUS) {
				{
				{
				setState(73); ((GwendolenagentContext)_localctx).p = plan();
				}
				}
				setState(78);
				_errHandler.sync(this);
	...
	public final Guard_atomContext guard_atom() throws RecognitionException {
		...
		try {
			...
			case BELIEVE:
				{
				setState(79); match(BELIEVE);
				setState(80); ((Guard_atomContext)_localctx).l = fof_expr();
				}
				break;
			case GOAL:
				{
				setState(81); match(GOAL);
				setState(82); ((Guard_atomContext)_localctx).gl = goal();
				}
				break;
			case SENT:
				{
				setState(83); match(SENT);
				setState(84); match(OPEN);
				{
				setState(85); ((Guard_atomContext)_localctx).s = agentnameterm();
				}
				...
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << CONST) | (1L << VAR) | (1L << UNNAMEDVAR))) != 0)) {
					{
					setState(87); ((Guard_atomContext)_localctx).an2 = agentnameterm();
					setState(88); match(COMMA);
					}
				}

				setState(92); ((Guard_atomContext)_localctx).p = performative();
				setState(93); match(COMMA);
				setState(94); ((Guard_atomContext)_localctx).t = fof_expr();
				setState(95); match(CLOSE);
				}
				break;
			case CONST:
			case SQOPEN:
				{
				setState(97); ((Guard_atomContext)_localctx).eq = fof_expr();
				}
				break;
			case TRUE:
				{
				setState(98); match(TRUE);
				}
				break;
			default:
	...
	public final GoalContext goal() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(101); ((GoalContext)_localctx).l = fof_expr();
			setState(102); match(SQOPEN);
			setState(103);
			_la = _input.LA(1);
	...
	public final PlanContext plan() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(106); ((PlanContext)_localctx).e = event();
			setState(107); match(COLON);
			setState(108); match(CURLYOPEN);
			setState(109); ((PlanContext)_localctx).g1 = pn_guard_atom();
			setState(114);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				setState(111); ((PlanContext)_localctx).gs = pn_guard_atom();
				}
				}
				setState(116);
				_errHandler.sync(this);
			...
			setState(117); match(CURLYCLOSE);
			setState(127);
			_la = _input.LA(1);
			if (_la==RULEARROW) {
				{
				setState(118); match(RULEARROW);
				setState(119); ((PlanContext)_localctx).d = deed();
				setState(124);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
					...
					setState(121); ((PlanContext)_localctx).ds = deed();
					}
					}
					setState(126);
					_errHandler.sync(this);
	...
	public final Pn_guard_atomContext pn_guard_atom() throws RecognitionException {
		...
		try {
			...
			setState(134); ((Pn_guard_atomContext)_localctx).gb = guard_atom();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final EventContext event() throws RecognitionException {
		...
		try {
			...
			case PLUS:
				...
				case RECEIVED:
					{
					setState(137); match(RECEIVED);
					setState(138); match(OPEN);
					setState(139); ((EventContext)_localctx).p = performative();
					setState(140); match(COMMA);
					setState(141); ((EventContext)_localctx).t = fof_expr();
					setState(142); match(CLOSE);
					}
					break;
				case CONST:
				case SQOPEN:
				case SHRIEK:
					...
					case SQOPEN:
						{
						setState(144); ((EventContext)_localctx).l = fof_expr();
						}
						break;
					case SHRIEK:
						{
						setState(145); match(SHRIEK);
						setState(146); ((EventContext)_localctx).g = goal();
						}
						break;
					default:
						throw new NoViableAltException(this);
			...
			case MINUS:
				{
				setState(152); match(MINUS);
				setState(157);
				switch (_input.LA(1)) {
				case CONST:
				case SQOPEN:
					{
					setState(153); ((EventContext)_localctx).l = fof_expr();
					}
					break;
				case SHRIEK:
					{
					setState(154); match(SHRIEK);
					setState(155); ((EventContext)_localctx).g = goal();
					}
					break;
				case COLON:
					{
	...
	public final DeedContext deed() throws RecognitionException {
		...
		try {
			...
			case MINUS:
				...
				case MINUS:
					...
					case PLUS:
						...
						case SQOPEN:
							{
							setState(164); ((DeedContext)_localctx).l = fof_expr();
							}
							break;
						case SHRIEK:
							{
							setState(165); match(SHRIEK);
							setState(166); ((DeedContext)_localctx).g = goal();
							}
							break;
						case ADD_PLAN:
							{
							setState(167); match(ADD_PLAN);
							setState(168); ((DeedContext)_localctx).p = fof_expr();
							}
							break;
						case LOCK:
							{
							setState(169); match(LOCK);
							}
							break;
						default:
							throw new NoViableAltException(this);
					...
					case MINUS:
						...
						case SQOPEN:
							{
							setState(173); ((DeedContext)_localctx).l = fof_expr();
							}
							break;
						case SHRIEK:
							{
							setState(174); match(SHRIEK);
							setState(175); ((DeedContext)_localctx).g = goal();
							}
							break;
						case LOCK:
							{
							setState(176); match(LOCK);
							}
							break;
						default:
							throw new NoViableAltException(this);
				...
				case SQOPEN:
					{
					setState(181); ((DeedContext)_localctx).a = action();
					}
					break;
				default:
					throw new NoViableAltException(this);
			...
			case MULT:
				{
				setState(184); ((DeedContext)_localctx).wf = waitfor();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final BruleContext brule() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(187); ((BruleContext)_localctx).head = fof_expr();
			setState(193);
			switch (_input.LA(1)) {
			case BRULEARROW:
				{
				setState(188); match(BRULEARROW);
				setState(189); ((BruleContext)_localctx).f = fof_expr();
				setState(190); match(SEMI);
				}
				break;
			case SEMI:
				{
				setState(192); match(SEMI);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final WaitforContext waitfor() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(195); match(MULT);
			setState(196); ((WaitforContext)_localctx).l = fof_expr();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ActionContext action() throws RecognitionException {
		...
		try {
			...
			case SEND:
				...
				setState(199); match(OPEN);
				setState(200); ((ActionContext)_localctx).an = fof_expr();
				setState(201); match(COMMA);
				setState(202); ((ActionContext)_localctx).p = performative();
				setState(203); match(COMMA);
				setState(204); ((ActionContext)_localctx).t = fof_expr();
				setState(205); match(CLOSE);
				}
				}
				break;
			case CONST:
			case SQOPEN:
				...
				{
				setState(207); ((ActionContext)_localctx).t = fof_expr();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final EnvironmentContext environment() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(210); ((EnvironmentContext)_localctx).w = classpath();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ClasspathContext classpath() throws RecognitionException {
		...
		try {
			...
			do {
				...
				setState(214); ((ClasspathContext)_localctx).w1 = word();
				}
				}
				setState(217); 
				_errHandler.sync(this);
	...
	public static class AgentnametermContext extends ParserRuleContext {
		public TerminalNode CONST() { return getToken(GwendolenParser.CONST, 0); }
		public TerminalNode VAR() { return getToken(GwendolenParser.VAR, 0); }
		public TerminalNode UNNAMEDVAR() { return getToken(GwendolenParser.UNNAMEDVAR, 0); }
		...
		try {
			...
			case CONST:
				...
				while (_la==IDPUNCT) {
					{
					{
					setState(224); match(IDPUNCT);
					setState(225); match(CONST);
					}
					}
					setState(230);
					_errHandler.sync(this);
				...
				if (_la==OPEN) {
					...
					case SQOPEN:
						{
						setState(232); fof_expr();
						}
						break;
					case QUOTED_STRING:
						{
						setState(233); match(QUOTED_STRING);
						}
						break;
					default:
						throw new NoViableAltException(this);
					...
					while (_la==COMMASEP) {
						{
						{
						setState(236); match(COMMASEP);
						setState(239);
						switch (_input.LA(1)) {
						case CONST:
						case SQOPEN:
							{
							setState(237); fof_expr();
							}
							break;
						case QUOTED_STRING:
							{
							setState(238); match(QUOTED_STRING);
							}
							break;
						default:
							throw new NoViableAltException(this);
			...
			case SQOPEN:
				{
				setState(249); match(SQOPEN);
				setState(250); fof_expr();
				setState(255);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMASEP) {
					{
					{
					setState(251); match(COMMASEP);
					setState(252); fof_expr();
					}
					}
					setState(257);
					_errHandler.sync(this);
				...
				if (_la==BAR) {
					{
					setState(258); match(BAR);
					setState(259); match(VAR);
					}
				}

				setState(262); match(SQCLOSE);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public static final String _serializedATN =
		...
		"\24\26\30\32\34\36 \"$\2\6\3\2\24\25\3\2\21\23\4\2\31\31\61\61\4\2\31"+
		"\31\61\62\u0123\2&\3\2\2\2\4(\3\2\2\2\6/\3\2\2\2\be\3\2\2\2\ng\3\2\2\2"+
		"\fl\3\2\2\2\16\u0086\3\2\2\2\20\u00a1\3\2\2\2\22\u00a3\3\2\2\2\24\u00bb"+
