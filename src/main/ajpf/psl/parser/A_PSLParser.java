// $ANTLR 3.5.1 /Users/lad/Eclipse/mcapl/src/main/ajpf/psl/parser/A_PSL.g 2015-03-24 13:18:25
...
public class A_PSLParser extends Parser {
	public static final String[] tokenNames = new String[] {
		...
		"IMP", "INTENDTODO", "INTENTION", "NEWLINE", "NOT", "NUMBER", "OPENBRACKET", 
		"OR", "PERCEPT", "RELEASE", "SQCLOSEBRACKET", "SQOPENBRACKET", "TRUE", 
		"UNNAMED_VAR", "UNTIL", "WS"
	};
	...
	@Override public String getGrammarFileName() { return "/Users/lad/Eclipse/mcapl/src/main/ajpf/psl/parser/A_PSL.g"; }
	...
	// /Users/lad/Eclipse/mcapl/src/main/ajpf/psl/parser/A_PSL.g:83:1: proposition returns [Abstract_Proposition p1] : (p2= beliefproperty |p3= goalproperty |p4= falseprop |p5= intentionproperty |p6= lastactionproperty |p7= perceptproperty |p= trueprop );
	public final Abstract_Proposition proposition() throws RecognitionException {
		...
		try {
			// /Users/lad/Eclipse/mcapl/src/main/ajpf/psl/parser/A_PSL.g:83:47: (p2= beliefproperty |p3= goalproperty |p4= falseprop |p5= intentionproperty |p6= lastactionproperty |p7= perceptproperty |p= trueprop )
			int alt10=7;
			switch ( input.LA(1) ) {
			case BELIEVE:
				{
			...
			switch (alt10) {
				...
				case 7 :
					...
					{
					pushFollow(FOLLOW_trueprop_in_proposition486);
					p=trueprop();
					state._fsp--;
	...
	public final Abstract_AgBelief beliefproperty() throws RecognitionException {
		...
		try {
			...
			{
			match(input,BELIEVE,FOLLOW_BELIEVE_in_beliefproperty502); 
			match(input,OPENBRACKET,FOLLOW_OPENBRACKET_in_beliefproperty504); 
			pushFollow(FOLLOW_agentname_in_beliefproperty508);
			ag=agentname();
			state._fsp--;

			match(input,COMMASEP,FOLLOW_COMMASEP_in_beliefproperty510); 
			pushFollow(FOLLOW_formula_in_beliefproperty514);
			f=formula();
			state._fsp--;

			match(input,CLOSEBRACKET,FOLLOW_CLOSEBRACKET_in_beliefproperty516); 
	...
	public final Abstract_AgGoal goalproperty() throws RecognitionException {
		...
		try {
			...
			{
			match(input,GOAL,FOLLOW_GOAL_in_goalproperty530); 
			match(input,OPENBRACKET,FOLLOW_OPENBRACKET_in_goalproperty532); 
			pushFollow(FOLLOW_agentname_in_goalproperty536);
			ag=agentname();
			state._fsp--;

			match(input,COMMASEP,FOLLOW_COMMASEP_in_goalproperty538); 
			pushFollow(FOLLOW_formula_in_goalproperty542);
			f=formula();
			state._fsp--;

			match(input,CLOSEBRACKET,FOLLOW_CLOSEBRACKET_in_goalproperty544); 
	...
	public final Abstract_FalseProp falseprop() throws RecognitionException {
		...
		try {
			...
			{
			match(input,FALSE,FOLLOW_FALSE_in_falseprop558); 
	...
	public final Abstract_AgIntention intentionproperty() throws RecognitionException {
		...
		try {
			...
			{
			match(input,INTENTION,FOLLOW_INTENTION_in_intentionproperty572); 
			match(input,OPENBRACKET,FOLLOW_OPENBRACKET_in_intentionproperty574); 
			pushFollow(FOLLOW_agentname_in_intentionproperty578);
			ag=agentname();
			state._fsp--;

			match(input,COMMASEP,FOLLOW_COMMASEP_in_intentionproperty580); 
			pushFollow(FOLLOW_formula_in_intentionproperty584);
			f=formula();
			state._fsp--;

			match(input,CLOSEBRACKET,FOLLOW_CLOSEBRACKET_in_intentionproperty586); 
	...
	public final Abstract_LastAction lastactionproperty() throws RecognitionException {
		...
		try {
			...
			{
			match(input,ACTION,FOLLOW_ACTION_in_lastactionproperty600); 
			match(input,OPENBRACKET,FOLLOW_OPENBRACKET_in_lastactionproperty602); 
			pushFollow(FOLLOW_agentname_in_lastactionproperty606);
			ag=agentname();
			state._fsp--;

			match(input,COMMASEP,FOLLOW_COMMASEP_in_lastactionproperty608); 
			pushFollow(FOLLOW_formula_in_lastactionproperty612);
			f=formula();
			state._fsp--;

			match(input,CLOSEBRACKET,FOLLOW_CLOSEBRACKET_in_lastactionproperty614); 
	...
	public final Abstract_Percept perceptproperty() throws RecognitionException {
		...
		try {
			...
			{
			match(input,PERCEPT,FOLLOW_PERCEPT_in_perceptproperty628); 
			match(input,OPENBRACKET,FOLLOW_OPENBRACKET_in_perceptproperty630); 
			pushFollow(FOLLOW_formula_in_perceptproperty636);
			f=formula();
			state._fsp--;

			match(input,CLOSEBRACKET,FOLLOW_CLOSEBRACKET_in_perceptproperty638); 
	...
	public final Abstract_AgIntendToDo intendtodoproperty() throws RecognitionException {
		...
		try {
			...
			{
			match(input,INTENDTODO,FOLLOW_INTENDTODO_in_intendtodoproperty651); 
			match(input,OPENBRACKET,FOLLOW_OPENBRACKET_in_intendtodoproperty653); 
			pushFollow(FOLLOW_agentname_in_intendtodoproperty657);
			ag=agentname();
			state._fsp--;

			match(input,COMMASEP,FOLLOW_COMMASEP_in_intendtodoproperty659); 
			pushFollow(FOLLOW_formula_in_intendtodoproperty665);
			f=formula();
			state._fsp--;

			match(input,CLOSEBRACKET,FOLLOW_CLOSEBRACKET_in_intendtodoproperty667); 
	...
	public final Abstract_TrueProp trueprop() throws RecognitionException {
		...
		try {
			...
			{
			match(input,TRUE,FOLLOW_TRUE_in_trueprop681); 
	...
	public final String agentname() throws RecognitionException {
		...
		try {
			...
			{
			CONST1=(Token)match(input,CONST,FOLLOW_CONST_in_agentname698); 
			s = CONST1.getText();
			}
	...
	public final Abstract_Formula formula() throws RecognitionException {
		...
		try {
			...
			{
			CONST2=(Token)match(input,CONST,FOLLOW_CONST_in_formula716); 
			...
			switch (alt11) {
				case 1 :
					...
					{
					match(input,OPENBRACKET,FOLLOW_OPENBRACKET_in_formula726); 
					pushFollow(FOLLOW_terms_in_formula728);
					terms(f);
					state._fsp--;

					match(input,CLOSEBRACKET,FOLLOW_CLOSEBRACKET_in_formula731); 
					}
					break;
		...
		try {
			...
			switch (alt14) {
				case 1 :
					...
					{
					NUMBER3=(Token)match(input,NUMBER,FOLLOW_NUMBER_in_subformula745); 
				...
				case 2 :
					...
					{
					UNNAMED_VAR4=(Token)match(input,UNNAMED_VAR,FOLLOW_UNNAMED_VAR_in_subformula781); 
				...
				case 3 :
					...
					{
					match(input,SQOPENBRACKET,FOLLOW_SQOPENBRACKET_in_subformula817); 
					pushFollow(FOLLOW_subformula_in_subformula821);
					h=subformula();
					state._fsp--;
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,COMMASEP,FOLLOW_COMMASEP_in_subformula827); 
							pushFollow(FOLLOW_subformula_in_subformula831);
							t=subformula();
							state._fsp--;
					...
					match(input,SQCLOSEBRACKET,FOLLOW_SQCLOSEBRACKET_in_subformula837); 
					}
					break;
				case 4 :
					// /Users/lad/Eclipse/mcapl/src/main/ajpf/psl/parser/A_PSL.g:118:10: CONST ( OPENBRACKET terms[$f] CLOSEBRACKET )?
					{
					CONST5=(Token)match(input,CONST,FOLLOW_CONST_in_subformula850); 
					...
					switch (alt13) {
						case 1 :
							...
							{
							match(input,OPENBRACKET,FOLLOW_OPENBRACKET_in_subformula864); 
							pushFollow(FOLLOW_terms_in_subformula866);
							terms(f);
							state._fsp--;

							match(input,CLOSEBRACKET,FOLLOW_CLOSEBRACKET_in_subformula869); 
							}
							break;
	...
	public final void terms(Abstract_MCAPLTerm f) throws RecognitionException {
		...
		try {
			...
			{
			pushFollow(FOLLOW_subformula_in_terms883);
			t=subformula();
			state._fsp--;
			...
			switch (alt15) {
				case 1 :
					...
					{
					match(input,COMMASEP,FOLLOW_COMMASEP_in_terms888); 
					pushFollow(FOLLOW_terms_in_terms890);
					terms(f);
					state._fsp--;
	...
	public static final BitSet FOLLOW_UNTIL_in_untilproperty115 = new BitSet(new long[]{0x0000000008AA70B0L});
	...
	public static final BitSet FOLLOW_RELEASE_in_releaseproperty150 = new BitSet(new long[]{0x0000000008AA70B0L});
	...
	public static final BitSet FOLLOW_IMP_in_impproperty185 = new BitSet(new long[]{0x0000000008AA70B0L});
	...
	public static final BitSet FOLLOW_AND_in_andproperty220 = new BitSet(new long[]{0x0000000008AA70B0L});
	...
	public static final BitSet FOLLOW_OR_in_orproperty255 = new BitSet(new long[]{0x0000000008AA70B0L});
	...
	public static final BitSet FOLLOW_ALWAYS_in_alwaysproperty292 = new BitSet(new long[]{0x0000000008AA7090L});
	...
	public static final BitSet FOLLOW_FINALLY_in_finallyproperty324 = new BitSet(new long[]{0x0000000008AA5090L});
	...
	public static final BitSet FOLLOW_NOT_in_notproperty355 = new BitSet(new long[]{0x0000000008A25090L});
	...
	public static final BitSet FOLLOW_OPENBRACKET_in_atom389 = new BitSet(new long[]{0x0000000008AA70B0L});
	...
	public static final BitSet FOLLOW_trueprop_in_proposition486 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_BELIEVE_in_beliefproperty502 = new BitSet(new long[]{0x0000000000200000L});
	public static final BitSet FOLLOW_OPENBRACKET_in_beliefproperty504 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_agentname_in_beliefproperty508 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_COMMASEP_in_beliefproperty510 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_formula_in_beliefproperty514 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_CLOSEBRACKET_in_beliefproperty516 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_GOAL_in_goalproperty530 = new BitSet(new long[]{0x0000000000200000L});
	public static final BitSet FOLLOW_OPENBRACKET_in_goalproperty532 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_agentname_in_goalproperty536 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_COMMASEP_in_goalproperty538 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_formula_in_goalproperty542 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_CLOSEBRACKET_in_goalproperty544 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_FALSE_in_falseprop558 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INTENTION_in_intentionproperty572 = new BitSet(new long[]{0x0000000000200000L});
	public static final BitSet FOLLOW_OPENBRACKET_in_intentionproperty574 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_agentname_in_intentionproperty578 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_COMMASEP_in_intentionproperty580 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_formula_in_intentionproperty584 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_CLOSEBRACKET_in_intentionproperty586 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ACTION_in_lastactionproperty600 = new BitSet(new long[]{0x0000000000200000L});
	public static final BitSet FOLLOW_OPENBRACKET_in_lastactionproperty602 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_agentname_in_lastactionproperty606 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_COMMASEP_in_lastactionproperty608 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_formula_in_lastactionproperty612 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_CLOSEBRACKET_in_lastactionproperty614 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_PERCEPT_in_perceptproperty628 = new BitSet(new long[]{0x0000000000200000L});
	public static final BitSet FOLLOW_OPENBRACKET_in_perceptproperty630 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_formula_in_perceptproperty636 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_CLOSEBRACKET_in_perceptproperty638 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INTENDTODO_in_intendtodoproperty651 = new BitSet(new long[]{0x0000000000200000L});
	public static final BitSet FOLLOW_OPENBRACKET_in_intendtodoproperty653 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_agentname_in_intendtodoproperty657 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_COMMASEP_in_intendtodoproperty659 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_formula_in_intendtodoproperty665 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_CLOSEBRACKET_in_intendtodoproperty667 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_TRUE_in_trueprop681 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CONST_in_agentname698 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CONST_in_formula716 = new BitSet(new long[]{0x0000000000200002L});
	public static final BitSet FOLLOW_OPENBRACKET_in_formula726 = new BitSet(new long[]{0x0000000014100800L});
	public static final BitSet FOLLOW_terms_in_formula728 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_CLOSEBRACKET_in_formula731 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_NUMBER_in_subformula745 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_UNNAMED_VAR_in_subformula781 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_SQOPENBRACKET_in_subformula817 = new BitSet(new long[]{0x0000000014100800L});
	public static final BitSet FOLLOW_subformula_in_subformula821 = new BitSet(new long[]{0x0000000002000200L});
	public static final BitSet FOLLOW_COMMASEP_in_subformula827 = new BitSet(new long[]{0x0000000014100800L});
	public static final BitSet FOLLOW_subformula_in_subformula831 = new BitSet(new long[]{0x0000000002000200L});
	public static final BitSet FOLLOW_SQCLOSEBRACKET_in_subformula837 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CONST_in_subformula850 = new BitSet(new long[]{0x0000000000200002L});
	public static final BitSet FOLLOW_OPENBRACKET_in_subformula864 = new BitSet(new long[]{0x0000000014100800L});
	public static final BitSet FOLLOW_terms_in_subformula866 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_CLOSEBRACKET_in_subformula869 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_subformula_in_terms883 = new BitSet(new long[]{0x0000000000000202L});
	public static final BitSet FOLLOW_COMMASEP_in_terms888 = new BitSet(new long[]{0x0000000014100800L});
	public static final BitSet FOLLOW_terms_in_terms890 = new BitSet(new long[]{0x0000000000000002L});
}
