 ...
 * 
 */
public class NativeAgIntendToDo extends Native_Proposition {
	...
	/**
	 * The formula that is the agent's action.
	 */
	 ...
	 * @param f  The goal.
	 */
	public NativeAgIntendToDo(String a, Abstract_Formula f) {
		action = f;
		agent = a;
	}
	...
	public boolean equals(Object p) {
		if (p instanceof NativeAgIntendToDo) {
			return (((NativeAgIntendToDo) p).getAction().equals(action) && ((NativeAgIntendToDo) p).getAgent().equals(agent));
		}
	 ...
	 */
	public NativeAgIntendToDo clone() {
		return(new NativeAgIntendToDo(agent, action));
	}
	...
	public String toString() {
		String s = "ItD(" + agent + "," + action.toString() + ")";
		return s;
	}
	...
	public String getEquivalentJPFClass() {
		return "ajpf.psl.ast.Abstract_AgIntendToDo";
	}
