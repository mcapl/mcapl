...
public class Tutorial3QuickTests extends TestJPF {
  ...
  public void pickuprubble_achieve () {
    if (verifyNoPropertyViolation(JPF_ARGS)){
    	String filename =  "/src/examples/gwendolen/tutorials/tutorial3/pickuprubble_achieve.ail";
...
/*  @Test //----------------------------------------------------------------------
  ...
  @Test //----------------------------------------------------------------------
  public void pickuprubble_goal () {
    if (verifyNoPropertyViolation(JPF_ARGS)){
    	String filename =  "/src/examples/gwendolen/tutorials/tutorial3/pickuprubble_goal.ail";
    	String prop_filename =  "/src/tests/gwendolen/tutorials/tutorial_props.psl";
    	String[] args = new String[3];
    	args[0] = filename;
    	args[1] = prop_filename;
  ...
  @Test //----------------------------------------------------------------------
  public void pickuprubble_goalat () {
    if (verifyNoPropertyViolation(JPF_ARGS)){
    	String filename =  "/src/examples/gwendolen/tutorials/tutorial3/pickuprubble_goalat.ail";
    	String prop_filename =  "/src/tests/gwendolen/tutorials/tutorial_props.psl";
    	String[] args = new String[3];
    	args[0] = filename;
    	args[1] = prop_filename;
